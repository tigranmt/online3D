...
(function() {
    ...
    if (window.requestAnimationFrame === void 0)
        window.requestAnimationFrame = function(b) {
            var c = Date.now(), e = Math.max(0, 16 - (c - a)), g = window.setTimeout(function() {
                b(c + e)
            }, e);
            a = c + e;
            return g
...
THREE.Vector3.prototype = {constructor: THREE.Vector3,set: function(a, b, c) {
    ...
    setLength: function(a) {
        ...
        var d = a.elements, f = d[0], e = d[4], g = d[8], h = d[1], i = d[5], j = d[9], l = d[2], n = d[6], d = d[10];
        if (b === void 0 || b === "XYZ") {
        ...
        var d = a.x * a.x, f = a.y * a.y, e = a.z * a.z, g = a.w * a.w;
        if (b === void 0 || b === "XYZ") {
...
THREE.Vector4.prototype = {constructor: THREE.Vector4,set: function(a, b, c, d) {
    ...
    lengthManhattan: function() {
        ...
        var b, c, d, a = a.elements, f = a[0];
        d = a[4];
        var e = a[8], g = a[1], h = a[5], i = a[9];
        c = a[2];
        b = a[6];
        var j = a[10];
        if (Math.abs(d - g) < 0.01 && Math.abs(e - c) < 0.01 && Math.abs(i - b) < 0.01) {
            if (Math.abs(d + g) < 0.1 && Math.abs(e + c) < 0.1 && Math.abs(i + b) < 0.1 && Math.abs(f + h + j - 3) < 0.1) {
                this.set(1, 0, 0, 0);
                return this
            }
            a = Math.PI;
...
THREE.Matrix3.prototype = {constructor: THREE.Matrix3,getInverse: function(a) {
        var b = a.elements, a = b[10] * b[5] - b[6] * b[9], c = -b[10] * b[1] + b[2] * b[9], d = b[6] * b[1] - b[2] * b[5], f = -b[10] * b[4] + b[6] * b[8], e = b[10] * b[0] - b[2] * b[8], g = -b[6] * b[0] + b[2] * b[4], h = b[9] * b[4] - b[5] * b[8], i = -b[9] * b[0] + b[1] * b[8], j = b[5] * b[0] - b[1] * b[4], b = b[0] * a + b[1] * f + b[2] * h;
...
THREE.Matrix4 = function(a, b, c, d, f, e, g, h, i, j, l, n, m, q, p, o) {
    ...
    this.set(a !== void 0 ? a : 1, b || 0, c || 0, d || 0, f || 0, e !== void 0 ? e : 1, g || 0, h || 0, i || 0, j || 0, l !== void 0 ? l : 1, n || 0, m || 0, q || 0, p || 0, o !== void 0 ? o : 1)
};
THREE.Matrix4.prototype = {constructor: THREE.Matrix4,set: function(a, b, c, d, f, e, g, h, i, j, l, n, m, q, p, o) {
        var r = this.elements;
        r[0] = a;
        r[4] = b;
        r[8] = c;
        ...
        var d = this.elements, 
        f = THREE.Matrix4.__v1, e = THREE.Matrix4.__v2, g = THREE.Matrix4.__v3;
        g.sub(a, b).normalize();
        if (g.length() === 0)
            g.z = 1;
        ...
        var c = a.elements, d = b.elements, f = this.elements, e = c[0], g = c[4], h = c[8], i = c[12], j = c[1], l = c[5], n = c[9], m = c[13], q = c[2], p = c[6], o = c[10], r = c[14], t = c[3], u = c[7], w = c[11], c = c[15], s = d[0], B = d[4], 
        v = d[8], A = d[12], E = d[1], z = d[5], M = d[9], D = d[13], G = d[2], H = d[6], O = d[10], F = d[14], J = d[3], I = d[7], K = d[11], d = d[15];
        f[0] = e * s + g * E + h * G + i * J;
        f[4] = e * B + g * z + h * H + i * I;
        f[8] = e * v + g * M + h * O + i * K;
        ...
        var b = this.elements, c = a.x, d = a.y, f = a.z, e = 1 / (b[3] * c + b[7] * d + b[11] * f + b[15]);
        a.x = (b[0] * c + b[4] * d + b[8] * f + b[12]) * e;
        a.y = (b[1] * c + b[5] * d + b[9] * f + b[13]) * e;
        a.z = (b[2] * c + b[6] * d + b[10] * f + b[14]) * e;
        return a
    },multiplyVector4: function(a) {
        var b = this.elements, c = a.x, d = a.y, f = a.z, e = a.w;
        a.x = b[0] * c + b[4] * d + b[8] * f + b[12] * e;
        a.y = b[1] * c + b[5] * d + b[9] * f + b[13] * e;
        a.z = b[2] * c + b[6] * d + b[10] * f + b[14] * e;
        ...
        var b = this.elements, c = a.x, d = a.y, f = a.z;
        ...
        var a = this.elements, b = a[0], c = a[4], d = a[8], f = a[12], e = a[1], g = a[5], h = a[9], i = a[13], j = a[2], l = a[6], n = a[10], m = a[14], q = a[3], p = a[7], o = a[11], a = a[15];
        return f * h * l * q - d * i * l * q - f * g * n * q + c * i * n * q + d * g * m * q - c * h * m * q - f * h * j * p + d * i * j * p + f * e * n * p - b * i * n * p - d * e * m * p + b * h * m * p + f * g * j * o - c * i * j * o - f * e * l * o + b * i * l * o + c * e * m * o - b * g * m * o - d * g * j * a + c * h * j * a + d * e * l * a - b * h * l * a - c * e * n * a + b * g * n * a
    },transpose: function() {
        ...
        var b = this.elements, c = a.elements, d = c[0], f = c[4], e = c[8], g = c[12], h = c[1], i = c[5], j = c[9], l = c[13], n = c[2], m = c[6], q = c[10], p = c[14], o = c[3], r = c[7], t = c[11], c = c[15];
        b[0] = j * p * r - l * q * r + l * m * t - i * p * t - j * m * c + i * q * c;
        b[4] = g * q * r - e * p * r - g * m * t + f * p * t + e * m * c - f * q * c;
        b[8] = e * l * r - g * j * r + g * i * t - f * l * t - e * i * c + f * j * c;
        b[12] = g * j * m - e * l * m - g * i * q + f * l * q + e * i * p - f * j * p;
        b[1] = l * q * o - j * p * o - l * n * t + h * p * t + j * n * c - h * q * c;
        b[5] = e * p * o - g * q * o + g * n * t - d * p * t - e * n * c + d * q * c;
        b[9] = g * j * o - e * l * o - g * h * t + d * l * t + e * h * c - d * j * c;
        b[13] = e * l * n - g * j * n + g * h * q - d * 
        l * q - e * h * p + d * j * p;
        b[2] = i * p * o - l * m * o + l * n * r - h * p * r - i * n * c + h * m * c;
        b[6] = g * m * o - f * p * o - g * n * r + d * p * r + f * n * c - d * m * c;
        b[10] = f * l * o - g * i * o + g * h * r - d * l * r - f * h * c + d * i * c;
        b[14] = g * i * n - f * l * n - g * h * m + d * l * m + f * h * p - d * i * p;
        b[3] = j * m * o - i * q * o - j * n * r + h * q * r + i * n * t - h * m * t;
        b[7] = f * q * o - e * m * o + e * n * r - d * q * r - f * n * t + d * m * t;
        b[11] = e * i * o - f * j * o - e * h * r + d * j * r + f * h * t - d * i * t;
        b[15] = f * j * n - e * i * n + e * h * m - d * j * m - f * h * q + d * i * q;
        this.multiplyScalar(1 / a.determinant());
        return this
    },setRotationFromEuler: function(a, b) {
        var c = this.elements, d = a.x, f = a.y, e = a.z, g = Math.cos(d), d = Math.sin(d), 
        h = Math.cos(f), f = Math.sin(f), i = Math.cos(e), e = Math.sin(e);
        if (b === void 0 || b === "XYZ") {
            var j = g * i, l = g * e, n = d * i, m = d * e;
            c[0] = h * i;
            c[4] = -h * e;
            c[8] = f;
            c[1] = l + n * f;
        ...
        var b = this.elements, c = a.x, d = a.y, f = a.z, e = a.w, g = c + c, h = d + d, i = f + f, a = c * g, j = c * h, c = c * i, l = d * h, d = d * 
        i, f = f * i, g = e * g, h = e * h, e = e * i;
        b[0] = 1 - (l + f);
        b[4] = j - e;
        b[8] = c + h;
        b[1] = j + e;
        ...
        var d = this.elements, f = THREE.Matrix4.__m1, e = THREE.Matrix4.__m2;
        f.identity();
        ...
        var d = this.elements, f = THREE.Matrix4.__v1, e = THREE.Matrix4.__v2, g = THREE.Matrix4.__v3;
        f.set(d[0], d[1], d[2]);
        e.set(d[4], d[5], d[6]);
        g.set(d[8], d[9], d[10]);
        ...
        var b = this.elements, a = a.elements, c = THREE.Matrix4.__v1, d = 1 / c.set(a[0], a[1], a[2]).length(), f = 1 / c.set(a[4], a[5], a[6]).length(), c = 1 / c.set(a[8], a[9], a[10]).length();
        b[0] = a[0] * d;
        b[1] = a[1] * d;
        b[2] = a[2] * d;
        b[4] = a[4] * f;
        ...
        var b = this.elements, c = b[4], d = b[5], f = b[6], e = b[7], g = b[8], h = b[9], i = b[10], j = b[11], l = Math.cos(a), a = Math.sin(a);
        b[4] = l * c + a * g;
        b[5] = l * d + a * h;
        b[6] = l * f + a * i;
        b[7] = l * e + a * j;
        ...
        var b = 
        this.elements, c = b[0], d = b[1], f = b[2], e = b[3], g = b[8], h = b[9], i = b[10], j = b[11], l = Math.cos(a), a = Math.sin(a);
        b[0] = l * c - a * g;
        b[1] = l * d - a * h;
        b[2] = l * f - a * i;
        b[3] = l * e - a * j;
        ...
        var b = this.elements, c = b[0], d = b[1], f = b[2], e = b[3], g = b[4], h = b[5], i = b[6], j = b[7], l = Math.cos(a), a = Math.sin(a);
        b[0] = l * c + a * g;
        b[1] = l * d + a * h;
        b[2] = l * f + a * i;
        b[3] = l * e + a * j;
        ...
        var d = a.x, f = a.y, e = a.z, g = Math.sqrt(d * d + f * f + e * e), d = d / g, f = f / g, e = e / g, g = d * d, h = f * f, i = e * e, j = Math.cos(b), l = Math.sin(b), n = 1 - j, m = d * f * n, q = d * e * n, n = f * e * n, d = d * l, p = f * l, l = e * l, e = g + (1 - g) * j, g = m + l, f = q - p, m = m - l, h = h + (1 - h) * j, l = n + d, q = q + p, n = n - d, i = i + (1 - i) * j, j = c[0], d = c[1], p = c[2], o = c[3], r = c[4], t = c[5], u = c[6], w = c[7], s = c[8], B = c[9], v = c[10], A = c[11];
        c[0] = e * j + g * r + f * s;
        c[1] = e * d + g * 
        t + f * B;
        c[2] = e * p + g * u + f * v;
        ...
        var c = Math.cos(b), d = Math.sin(b), f = 1 - c, e = a.x, g = a.y, h = a.z, i = f * e, j = f * g;
        this.set(i * e + c, i * g - d * h, i * h + d * g, 0, i * g + d * h, j * g + c, j * h - d * e, 0, i * h - d * g, j * h + d * e, f * h * h + c, 0, 0, 0, 0, 1);
        return this
        ...
        var g = this.elements, h = b - a, i = c - d, j = e - f;
        g[0] = 2 / h;
        g[4] = 0;
        g[8] = 0;
        g[12] = -((b + a) / h);
...
THREE.Frustum.prototype.setFromMatrix = function(a) {
    var b = this.planes, c = a.elements, a = c[0], d = c[1], f = c[2], e = c[3], g = c[4], h = c[5], i = c[6], j = c[7], l = c[8], n = c[9], m = c[10], q = c[11], p = c[12], o = c[13], r = c[14], c = c[15];
...
THREE.Frustum.prototype.contains = function(a) {
    for (var b = 0, c = this.planes, b = a.matrixWorld, d = b.elements, a = -a.geometry.boundingSphere.radius * b.getMaxScaleOnAxis(), f = 0; f < 6; f++) {
...
(function(a) {
    ...
    var b = new a.Vector3, c = new a.Vector3, d = new a.Vector3, f = new a.Vector3, e = new a.Vector3, g = new a.Vector3, h = new a.Matrix4, i = function(a, b) {
        ...
        n.sub(a, 
        b);
        var a = j.dot(j), b = j.dot(l), c = j.dot(n), f = l.dot(l), d = l.dot(n), e = 1 / (a * f - b * b), f = (f * c - b * d) * e, a = (a * d - b * c) * e;
        ...
        if (i instanceof a.Particle) {
            ...
            if (n > p)
                return l;
            var v, 
            A, E = i.geometry, z = E.vertices, M, D, G;
            ...
            for (v = E.faces.length; p < v; p++) {
                ...
                if (n !== void 0) {
                    ...
                    if (!(Math.abs(n) < O)) {
                        A = e.dot(f) / n;
                        if (!(A < 0) && (G === 
                        a.DoubleSide || (G === a.FrontSide ? n < 0 : n > 0))) {
                            ...
                            if (o instanceof a.Face3) {
                                ...
                                if (q(g, n, A, G)) {
                                    ...
                                    n = b.distanceTo(A);
                                    if (!(n < j.near || n > j.far)) {
                                        o = {distance: n,point: A,face: o,faceIndex: p,object: i};
                                        l.push(o)
                                    }
                                }
...
THREE.Rectangle = function() {
    ...
    var b = 0, c = 0, d = 0, f = 0, e = 0, g = 0, h = true;
    this.getX = function() {
        return b
    };
    this.getY = function() {
    ...
    this.add3Points = function(e, g, l, n, m, q) {
        if (h === true) {
            ...
            b = e < l ? e < m ? e < b ? e : b : m < b ? m : b : l < m ? l < b ? l : b : m < b ? m : b;
            c = g < n ? g < q ? g < c ? g : c : q < c ? q : c : n < q ? n < c ? n : c : q < c ? q : c;
            d = e > l ? e > m ? e > d ? e : d : m > d ? m : d : l > m ? l > d ? l : d : m > d ? m : d;
            f = g > n ? g > q ? g > f ? g : f : q > f ? q : f : n > q ? n > f ? n : f : q > f ? q : f
        }
        a()
    };
    ...
    this.intersects = function(a) {
        return d < a.getLeft() || b > a.getRight() || f < a.getTop() || c > a.getBottom() ? false : true
    };
    this.empty = function() {
        h = true;
        f = d = c = b = 0;
...
THREE.Object3D.prototype = {constructor: THREE.Object3D,applyMatrix: function(a) {
        ...
        this.useQuaternion === false ? this.matrix.setRotationFromEuler(this.rotation, this.eulerOrder) : this.matrix.setRotationFromQuaternion(this.quaternion);
...
THREE.Projector = function() {
    ...
    function d(a, b) {
        var c = 0, d = 1, f = a.z + a.w, e = b.z + b.w, g = -a.z + a.w, h = -b.z + b.w;
        if (f >= 0 && e >= 0 && g >= 0 && h >= 0)
            return true;
        if (f < 0 && e < 0 || g < 0 && h < 0)
            return false;
    ...
    var f, e, g = [], h = 0, i, j, l = [], n = 0, m, q, p = [], o = 0, r, t = [], u = 0, w, s, B = [], v = 0, A, E, z = [], M = 0, D = {objects: [],sprites: [],lights: [],elements: []}, G = new THREE.Vector3, H = new THREE.Vector4, O = new THREE.Matrix4, F = new THREE.Matrix4, J = new THREE.Frustum, I = new THREE.Vector4, K = new THREE.Vector4;
    ...
    this.projectScene = function(g, h, n, L) {
        var ba = h.near, Q = h.far, fa = false, ta, da, ga, N, U, ia, Ia, pa, ua, Ca, Ja, Xa, ja, pb, Oa, Ya;
        E = s = r = q = 0;
        D.elements.length = 0;
        g.updateMatrixWorld();
        h.parent === 
        void 0 && h.updateMatrixWorld();
        ...
        for (n = D.objects.length; g < n; g++) {
            ...
            if (pa instanceof THREE.Mesh) {
                ...
                for (da = ga.length; ta < da; ta++) {
                    ...
                    i.positionScreen.x = i.positionScreen.x / 
                    i.positionScreen.w;
                ...
                for (ta = Xa.length; ga < ta; ga++) {
                    ...
                    if (da !== void 0) {
                        ...
                        if (Ia instanceof THREE.Face3) {
                            ...
                            U = l[Ia.b];
                            ja = l[Ia.c];
                            if (N.visible === true && U.visible === true && ja.visible === true) {
                                fa = (ja.positionScreen.x - N.positionScreen.x) * (U.positionScreen.y - N.positionScreen.y) - (ja.positionScreen.y - N.positionScreen.y) * (U.positionScreen.x - 
                                N.positionScreen.x) < 0;
                                if (ia === THREE.DoubleSide || fa === (ia === THREE.FrontSide)) {
                                    if (q === o) {
                            ...
                            ja = l[Ia.c];
                            Oa = l[Ia.d];
                            if (N.visible === true && U.visible === true && ja.visible === true && Oa.visible === true) {
                                fa = (Oa.positionScreen.x - N.positionScreen.x) * (U.positionScreen.y - N.positionScreen.y) - (Oa.positionScreen.y - N.positionScreen.y) * 
                                (U.positionScreen.x - N.positionScreen.x) < 0 || (U.positionScreen.x - ja.positionScreen.x) * (Oa.positionScreen.y - ja.positionScreen.y) - (U.positionScreen.y - ja.positionScreen.y) * (Oa.positionScreen.x - ja.positionScreen.x) < 0;
                                if (ia === THREE.DoubleSide || fa === (ia === THREE.FrontSide)) {
                                    if (r === u) {
                        ...
                        fa === false && (ia === THREE.BackSide || ia === THREE.DoubleSide) && 
                        ...
                        for (U = Ia.length; N < U; N++) {
                            ...
                            ja.copy(Ia[N]);
                            fa === false && (ia === THREE.BackSide || ia === THREE.DoubleSide) && ja.negate();
        ...
        for (n = D.sprites.length; g < n; g++) {
            ...
            if (pa instanceof THREE.Particle) {
                ...
                if (H.z > 0 && H.z < 1) {
                    ...
                    A.scale.x = pa.scale.x * Math.abs(A.x - (H.x + h.projectionMatrix.elements[0]) / (H.w + h.projectionMatrix.elements[12]));
                    A.scale.y = pa.scale.y * Math.abs(A.y - (H.y + h.projectionMatrix.elements[5]) / (H.w + h.projectionMatrix.elements[13]));
...
THREE.Quaternion.prototype = {constructor: THREE.Quaternion,set: function(a, b, c, d) {
        ...
        var c = Math.cos(a.x / 2), d = Math.cos(a.y / 2), f = Math.cos(a.z / 2), e = Math.sin(a.x / 2), g = Math.sin(a.y / 2), h = Math.sin(a.z / 2);
        if (b === void 0 || b === "XYZ") {
            this.x = e * d * f + c * g * h;
            this.y = c * g * f - e * d * h;
            this.z = c * d * h + e * g * f;
        ...
        var b = a.elements, c = b[0], a = b[4], d = b[8], f = b[1], e = b[5], g = b[9], h = b[2], i = b[6], b = b[10], j = c + e + b;
        if (j > 0) {
            c = 0.5 / Math.sqrt(j + 1);
            this.w = 0.25 / c;
            this.x = (i - g) * c;
        ...
        var c = a.x, d = a.y, f = a.z, e = a.w, g = b.x, h = b.y, i = b.z, j = b.w;
        ...
        b || (b = a);
        var c = a.x, d = a.y, f = a.z, e = this.x, g = 
        this.y, h = this.z, i = this.w, j = i * c + g * f - h * d, l = i * d + h * c - e * f, n = i * f + e * d - g * c, c = -e * c - g * d - h * f;
        b.x = j * i + c * -e + l * -h - n * -g;
        b.y = l * i + c * -g + n * -e - j * -h;
        b.z = n * i + c * -h + j * -g - l * -e;
        return b
...
THREE.Quaternion.slerp = function(a, b, c, d) {
    ...
    var b = Math.acos(f), e = Math.sqrt(1 - f * f);
    if (Math.abs(e) < 0.001) {
        c.w = 0.5 * (a.w + c.w);
        c.x = 0.5 * (a.x + c.x);
        c.y = 0.5 * (a.y + c.y);
...
THREE.Geometry.prototype = {constructor: THREE.Geometry,applyMatrix: function(a) {
        ...
        for (d = this.faces.length; c < d; c++) {
            ...
            f.__originalFaceNormal.copy(f.normal) : f.__originalFaceNormal = f.normal.clone();
        ...
        for (b = this.morphTargets.length; a < b; a++) {
            if (!this.morphNormals[a]) {
                ...
                for (d = this.faces.length; c < d; c++) {
                    f = this.faces[c];
                    i = new THREE.Vector3;
                    j = f instanceof THREE.Face3 ? {a: new THREE.Vector3,b: new THREE.Vector3,c: new THREE.Vector3} : {a: new THREE.Vector3,b: new THREE.Vector3,c: new THREE.Vector3,d: new THREE.Vector3};
                    g.push(i);
                    h.push(j)
                }
            }
        ...
        var b, c, d, f, e, g, h, i, j, l, n, m, q, p, o, r, t, u, w, s, B, v, A, E, z = [], M = [], D = new THREE.Vector3, G = new THREE.Vector3, H = new THREE.Vector3, O = new THREE.Vector3, F = new THREE.Vector3;
        b = 0;
        for (c = 
        ...
        var a = {}, b = [], c = [], d, f = Math.pow(10, 4), e, g, h, i;
        e = 0;
            ...
            if (a instanceof THREE.Face3) {
                ...
                for (f = 3; f > 0; f--)
                    if (d.indexOf(a["abcd"[f]]) !== f) {
                        d.splice(f, 1);
                        this.faces[e] = new THREE.Face3(d[0], d[1], d[2], a.normal, a.color, 
                        a.materialIndex);
                        d = 0;
...
THREE.BufferGeometry.prototype = {constructor: THREE.BufferGeometry,applyMatrix: function(a) {
        ...
        if (this.attributes.position)
            b = this.attributes.position.array;
        ...
        if (!this.boundingBox)
            this.boundingBox = {min: new THREE.Vector3(Infinity, Infinity,
                Infinity), max: new THREE.Vector3(-Infinity, -Infinity, -Infinity)
            };
        var a = this.attributes.position.array;
        if (a)
            for (var b = this.boundingBox, c, d, f, e = 0, g = a.length; e < g; e = e + 3) {
                c = a[e];
                d = a[e + 1];
                f = a[e + 2];
                if (c < b.min.x)
        ...
        if (this.attributes.position && this.attributes.index) {
            ...
            var f = this.offsets, e = this.attributes.index.array, g = this.attributes.position.array, h = this.attributes.normal.array, i, j, l, n, m, q, p = new THREE.Vector3, o = new THREE.Vector3, r = new THREE.Vector3, t = new THREE.Vector3, u = new THREE.Vector3;
            c = 0;
        ...
        if (this.attributes.index === void 0 || this.attributes.position === void 0 || this.attributes.normal === void 0 || this.attributes.uv === void 0)
            ...
            var b = this.attributes.index.array, c = this.attributes.position.array, d = this.attributes.normal.array, f = this.attributes.uv.array, e = c.length / 3;
            if (this.attributes.tangent === 
            void 0) {
                var g = 4 * e;
                this.attributes.tangent = {itemSize: 4,array: new Float32Array(g),numItems: g}
            }
            for (var h = this.attributes.tangent.array, i = [], j = [], g = 0; g < e; g++) {
                i[g] = new THREE.Vector3;
                j[g] = new THREE.Vector3
            }
            var l, n, m, q, p, o, r, t, u, w, s, B, v, A, E, e = new THREE.Vector3, g = new THREE.Vector3, z, M, D, G, H, O, F, J = this.offsets;
            D = 0;
            ...
            var K = new THREE.Vector3, V = new THREE.Vector3, Y = new THREE.Vector3, $ = new THREE.Vector3, L, ba, Q;
            D = 0;
            for (G = J.length; D < G; ++D) {
                M = J[D].start;
                H = J[D].count;
...
THREE.Spline = function(a) {
    ...
    this.points = a;
    var c = [], d = {x: 0,y: 0,z: 0}, f, e, g, h, i, j, l, n, m;
    ...
    this.getPoint = function(a) {
        ...
        c[3] = e > this.points.length - 3 ? this.points.length - 1 : 
        e + 2;
        j = this.points[c[0]];
        l = this.points[c[1]];
        n = this.points[c[2]];
    ...
    this.getLength = function(a) {
        var b, c, d, f = b = b = 0, e = new THREE.Vector3, g = new THREE.Vector3, h = [], i = 0;
        h[0] = 0;
        a || (a = 100);
    ...
    this.reparametrizeByArcLength = function(a) {
        var b, c, d, f, e, g, h = [], i = new THREE.Vector3, l = this.getLength();
...
THREE.Loader.prototype = {constructor: THREE.Loader,crossOrigin: "anonymous",addStatusElement: function() {
        ...
        function f(a, f, e, h, i, j, r) {
            var t = e.toLowerCase().endsWith(".dds"), u = b + "/" + e;
            if (t) {
            ...
            if (h) {
                ...
                if (h[0] !== 1)
                    a[f].wrapS = THREE.RepeatWrapping;
                if (h[1] !== 1)
                    a[f].wrapT = THREE.RepeatWrapping
            }
            i && a[f].offset.set(i[0], i[1]);
            if (j) {
                e = {repeat: THREE.RepeatWrapping,
        ...
        i = {color: 15658734,opacity: 1,map: null,lightMap: null,normalMap: null,bumpMap: null,wireframe: false};
        if (a.shading) {
        ...
        if (a.depthTest !== void 0)
            i.depthTest = a.depthTest;
        if (a.depthWrite !== void 0)
            i.depthWrite = a.depthWrite;
        if (a.visible !== void 0)
            i.visible = a.visible;
        if (a.flipSided !== 
        void 0)
            i.side = THREE.BackSide;
        if (a.doubleSided !== void 0)
            i.side = THREE.DoubleSide;
        if (a.wireframe !== void 0)
            i.wireframe = a.wireframe;
        ...
        if (a.colorDiffuse)
            i.color = e(a.colorDiffuse);
        else if (a.DbgColor)
            i.color = a.DbgColor;
        if (a.colorSpecular)
            i.specular = e(a.colorSpecular);
        if (a.colorAmbient)
            i.ambient = e(a.colorAmbient);
        if (a.transparency)
            i.opacity = a.transparency;
        if (a.specularCoef)
            i.shininess = 
            a.specularCoef;
        a.mapDiffuse && b && f(i, "map", a.mapDiffuse, a.mapDiffuseRepeat, a.mapDiffuseOffset, a.mapDiffuseWrap, a.mapDiffuseAnisotropy);
        a.mapLight && b && f(i, "lightMap", a.mapLight, a.mapLightRepeat, a.mapLightOffset, a.mapLightWrap, a.mapLightAnisotropy);
        a.mapBump && b && f(i, "bumpMap", a.mapBump, a.mapBumpRepeat, a.mapBumpOffset, a.mapBumpWrap, a.mapBumpAnisotropy);
        a.mapNormal && b && f(i, "normalMap", a.mapNormal, a.mapNormalRepeat, a.mapNormalOffset, a.mapNormalWrap, a.mapNormalAnisotropy);
        a.mapSpecular && b && f(i, "specularMap", 
        a.mapSpecular, a.mapSpecularRepeat, a.mapSpecularOffset, a.mapSpecularWrap, a.mapSpecularAnisotropy);
        if (a.mapBumpScale)
            i.bumpScale = a.mapBumpScale;
        if (a.mapNormal) {
            ...
            if (i.opacity !== void 0)
                j.uOpacity.value = i.opacity;
            i = new THREE.ShaderMaterial({fragmentShader: h.fragmentShader,vertexShader: h.vertexShader,uniforms: j,lights: true,fog: true})
        } else
            i = new THREE[h](i);
        if (a.DbgName !== void 0)
            i.name = a.DbgName;
...
THREE.BinaryLoader.prototype.loadAjaxBuffers = function(a, b, c, d, f) {
    var e = new XMLHttpRequest, g = c + "/" + a.buffers, h = 0;
    e.onreadystatechange = function() {
        if (e.readyState == 4)
            if (e.status == 200 || e.status == 0) {
                var c = e.response;
                if (c === void 0)
                    c = (new Uint8Array(e.responseBody)).buffer;
                THREE.BinaryLoader.prototype.createBinModel(c, b, d, a.materials)
            } else
                console.error("THREE.BinaryLoader: Couldn't load [" + g + "] [" + e.status + "]");
            ...
            e.readyState == 
            2 && (h = e.getResponseHeader("Content-Length"))
    };
    e.open("GET", g, true);
...
THREE.BinaryLoader.prototype.createBinModel = function(a, b, c, d) {
    var f = function(b) {
        ...
        function E(b, c) {
            var d, f, e, g, h, i, j, l, n = new Uint32Array(a, c, 3 * b);
            for (d = 0; d < b; d++) {
                f = n[d * 3];
                e = n[d * 3 + 1];
                g = n[d * 3 + 2];
                ...
                m.push(new THREE.UV(e, 
                l));
                g.push(m)
            }
        }
        function z(b, c) {
            var d, f, e, g, h, i, j, l, n, m, o = new Uint32Array(a, c, 4 * b);
            for (d = 0; d < b; d++) {
                f = o[d * 4];
                e = o[d * 4 + 1];
                g = o[d * 4 + 2];
        ...
        function G(b, c, d, f) {
            for (var e, g, h, i, j, l, n, c = new Uint32Array(a, c, 3 * b), d = new Uint32Array(a, d, 3 * b), m = new Uint16Array(a, f, b), f = 0; f < b; f++) {
                e = c[f * 3];
                g = c[f * 3 + 1];
                h = c[f * 3 + 2];
                j = d[f * 3];
                ...
                n = d[f * 3 + 2];
                i = m[f];
                var o = J[l * 3], p = J[l * 3 + 1];
                l = J[l * 3 + 2];
                var q = J[n * 3], 
                r = J[n * 3 + 1];
                n = J[n * 3 + 2];
                O.faces.push(new THREE.Face3(e, g, h, [new THREE.Vector3(J[j * 3], J[j * 3 + 1], J[j * 3 + 2]), new THREE.Vector3(o, p, l), new THREE.Vector3(q, r, n)], null, i))
            }
        }
        function H(b, c, d, f) {
            for (var e, g, h, i, j, l, n, m, o, c = new Uint32Array(a, c, 4 * b), d = new Uint32Array(a, d, 4 * b), p = new Uint16Array(a, f, b), f = 0; f < b; f++) {
                e = c[f * 4];
                g = c[f * 4 + 1];
                h = c[f * 4 + 2];
                i = c[f * 4 + 3];
                ...
                o = d[f * 4 + 3];
                j = p[f];
                var q = J[n * 3], r = J[n * 3 + 1];
                n = J[n * 3 + 2];
                var s = J[m * 3], t = J[m * 3 + 1];
                m = J[m * 3 + 2];
                var v = J[o * 3], u = J[o * 3 + 1];
                o = J[o * 3 + 2];
                O.faces.push(new THREE.Face4(e, 
                g, h, i, [new THREE.Vector3(J[l * 3], J[l * 3 + 1], J[l * 3 + 2]), new THREE.Vector3(q, r, n), new THREE.Vector3(s, t, m), new THREE.Vector3(v, u, o)], null, j))
            }
        }
        var O = this, F = 0, J = [], I = [], K, V, Y;
        ...
        j = w * (Y + j * 4);
        Y = F;
        var F = new Float32Array(a, F, n * 3), $, L, ba, Q;
        for ($ = 0; $ < n; $++) {
            L = F[$ * 3];
            ba = F[$ * 3 + 1];
            Q = F[$ * 3 + 2];
        ...
        THREE.Loader.prototype.hasNormals(this) && 
    ...
    e.onreadystatechange = function() {
        if (e.readyState === e.DONE)
            if (e.status === 200 || e.status === 0) {
                ...
                console.error("THREE.JSONLoader: Couldn't load [" + b + "] [" + e.status + "]");
            ...
            e.readyState === e.HEADERS_RECEIVED && (g = e.getResponseHeader("Content-Length"))
    };
    e.open("GET", b, true);
    e.send(null)
};
THREE.JSONLoader.prototype.createModel = function(a, b, c) {
    var d = new THREE.Geometry, f = a.scale !== void 0 ? 1 / a.scale : 1;
    this.initMaterials(d, a.materials, c);
    var e, g, h, i, j, l, n, m, q, p, o, r, t, u, w = a.faces;
    q = a.vertices;
...
THREE.GeometryLoader.prototype = {constructor: THREE.GeometryLoader,load: function(a) {
        ...
        d.addEventListener("load", function(d) {
            d.target.responseText ? c = b.parse(JSON.parse(d.target.responseText), f) : b.dispatchEvent({type: "error",message: "Invalid file [" + a + "]"})
        }, false);
        ...
        var c = this, d = new THREE.Geometry, f = a.scale !== void 0 ? 1 / a.scale : 1;
        if (a.materials) {
            d.materials = [];
            for (var e = 0; e < a.materials.length; ++e) {
                var g = a.materials[e], h = function(a) {
                    a = Math.log(a) / Math.LN2;
                    return Math.floor(a) == a
                }, i = function(a) {
                    a = Math.log(a) / Math.LN2;
                    ...
                    if (e) {
                        ...
                        if (e[0] !== 1)
                            a[d].wrapS = THREE.RepeatWrapping;
                        if (e[1] !== 1)
                    ...
                    return (a[0] * 255 << 16) + (a[1] * 255 << 8) + a[2] * 255
                }, n = "MeshLambertMaterial", m = {color: 15658734,opacity: 1,map: null,lightMap: null,normalMap: null,bumpMap: null,wireframe: false};
                if (g.shading) {
                    var q = g.shading.toLowerCase();
                    q === "phong" ? n = "MeshPhongMaterial" : q === "basic" && (n = "MeshBasicMaterial")
                }
                ...
                if (g.depthTest !== void 0)
                    m.depthTest = g.depthTest;
                if (g.depthWrite !== void 0)
                ...
                if (g.colorDiffuse)
                    m.color = l(g.colorDiffuse);
                else if (g.DbgColor)
                    m.color = g.DbgColor;
                if (g.colorSpecular)
                    m.specular = l(g.colorSpecular);
                if (g.colorAmbient)
                    m.ambient = 
                    l(g.colorAmbient);
                if (g.transparency)
                ...
                if (g.specularCoef)
                    m.shininess = g.specularCoef;
                if (g.visible !== void 0)
                    m.visible = g.visible;
                if (g.flipSided !== void 0)
                    m.side = THREE.BackSide;
                if (g.doubleSided !== void 0)
                    m.side = THREE.DoubleSide;
                if (g.wireframe !== void 0)
                    m.wireframe = g.wireframe;
                ...
                g.mapBump && j(m, "bumpMap", g.mapBump, 
                g.mapBumpRepeat, g.mapBumpOffset, g.mapBumpWrap);
                ...
                if (g.mapNormal) {
                    ...
                    if (m.opacity !== void 0)
                        l.uOpacity.value = m.opacity;
                    m = new THREE.ShaderMaterial({fragmentShader: j.fragmentShader,vertexShader: j.vertexShader,uniforms: l,lights: true,fog: true})
                } else
                    m = new THREE[n](m);
                if (g.DbgName !== void 0)
                    m.name = g.DbgName;
        ...
        var g = a.faces, p = a.vertices, m = a.normals, j = a.colors, l = 0;
        if (a.uvs)
            for (e = 0; e < a.uvs.length; e++)
                a.uvs[e].length && l++;
        for (e = 0; e < l; e++) {
        ...
        n = 0;
        for (q = g.length; n < q; ) {
            var r = g[n++], t = r & 2, e = r & 4, u = r & 8, w = r & 16, p = r & 32, s = r & 64, o = r & 128;
            if (r & 1) {
                r = new THREE.Face4;
                r.a = g[n++];
                r.b = g[n++];
            ...
            if (e)
                for (e = 0; e < l; e++) {
                    var A = a.uvs[e], t = g[n++], E = A[t * 2], t = A[t * 2 + 1];
        ...
        if (a.skinWeights) {
            ...
            for (g = a.skinWeights.length; e < g; e = e + 2)
                d.skinWeights.push(new THREE.Vector4(a.skinWeights[e], a.skinWeights[e + 1], 0, 0))
        }
        if (a.skinIndices) {
            e = 0;
            for (g = a.skinIndices.length; e < g; e = e + 2) {
                m = 0;
                d.skinIndices.push(new THREE.Vector4(a.skinIndices[e], a.skinIndices[e + 1], m, 0))
            }
        }
        d.bones = a.bones;
        d.animation = a.animation;
        if (a.morphTargets) {
            ...
            for (g = a.morphTargets.length; e < g; e++) {
                d.morphTargets[e] = {};
                d.morphTargets[e].name = 
                a.morphTargets[e].name;
...
THREE.SceneLoader.prototype.parse = function(a, b, c) {
    ...
    function h() {
        i.callbackProgress({totalModels: F,totalTextures: J,loadedModels: F - H,loadedTextures: J - O}, I);
        i.onLoadProgress();
        H === 0 && O === 0 && b(I)
    }
    var i = this, j = THREE.Loader.prototype.extractUrlBase(c), l, n, m, q, p, o, r, t, u, w, s, B, v, A, E, z, M, D, G, H, O, F, J, I, K = a;
    ...
    for (q in K.cameras) {
        v = 
        K.cameras[q];
        v.type === "perspective" ? M = new THREE.PerspectiveCamera(v.fov, v.aspect, v.near, v.far) : v.type === "ortho" && (M = new THREE.OrthographicCamera(v.left, v.right, v.top, v.bottom, v.near, v.far));
        u = v.position;
        c = v.target;
        v = v.up;
    ...
    for (m in K.lights) {
        ...
        if (c.type === "directional") {
            u = c.direction;
            t = new THREE.DirectionalLight(q, 
            M);
            ...
            c.type === "ambient" && (t = new THREE.AmbientLight(q));
        I.scene.add(t);
        I.lights[m] = t
    }
    for (p in K.fogs) {
        m = K.fogs[p];
        m.type === "linear" ? D = new THREE.Fog(0, m.near, m.far) : m.type === "exp2" && (D = new THREE.FogExp2(0, m.density));
        v = m.color;
    ...
    if (I.fogs && K.defaults.fog)
        I.scene.fog = I.fogs[K.defaults.fog];
    ...
    for (l in K.geometries) {
        p = K.geometries[l];
        if (p.type === "cube") {
            E = new THREE.CubeGeometry(p.width, p.height, p.depth, p.segmentsWidth, p.segmentsHeight, p.segmentsDepth, null, p.flipped, p.sides);
            I.geometries[l] = E
        } else if (p.type === "plane") {
            E = 
            new THREE.PlaneGeometry(p.width, p.height, p.segmentsWidth, p.segmentsHeight);
            I.geometries[l] = E
        } else if (p.type === "sphere") {
            E = new THREE.SphereGeometry(p.radius, p.segmentsWidth, p.segmentsHeight);
            I.geometries[l] = E
        } else if (p.type === "cylinder") {
            E = new THREE.CylinderGeometry(p.topRad, p.botRad, p.height, p.radSegs, p.heightSegs);
            I.geometries[l] = E
            ...
            D = {};
            for (G in p)
                G !== "type" && G !== "url" && (D[G] = p[G]);
            this.geometryHandlerMap[p.type].loaderObject.load(d(p.url, K.urlBaseType), e(l), D)
    ...
    for (o in K.textures) {
        ...
        if (l.url instanceof Array) {
            ...
            D = a(1);
            G = G ? THREE.ImageUtils.loadCompressedTexture(p, l.mapping, D) : THREE.ImageUtils.loadTexture(p, 
            l.mapping, D);
            if (THREE[l.minFilter] !== void 0)
                G.minFilter = THREE[l.minFilter];
            if (THREE[l.magFilter] !== void 0)
                G.magFilter = THREE[l.magFilter];
            if (l.anisotropy)
                G.anisotropy = l.anisotropy;
            if (l.repeat) {
    ...
    for (n in K.materials) {
        ...
        for (A in r.parameters)
            if (A === "envMap" || A === "map" || A === "lightMap" || A === "bumpMap")
                ...
                r.parameters[A] = r.parameters[A] === "flat" ? THREE.FlatShading : THREE.SmoothShading;
            else if (A === "side")
                r.parameters[A] = r.parameters[A] == "double" ? THREE.DoubleSide : r.parameters[A] == "back" ? THREE.BackSide : THREE.FrontSide;
            else if (A === "blending")
                r.parameters[A] = r.parameters[A] in THREE ? 
                THREE[r.parameters[A]] : THREE.NormalBlending;
            else if (A === "combine")
                r.parameters[A] = r.parameters[A] == "MixOperation" ? THREE.MixOperation : THREE.MultiplyOperation;
            else if (A === "vertexColors")
        ...
        if (r.parameters.normalMap) {
            ...
            r.parameters.normalScale && a.uNormalScale.value.set(r.parameters.normalScale[0], r.parameters.normalScale[1]);
            if (r.parameters.map) {
            ...
            if (r.parameters.envMap) {
                ...
                a.uReflectivity.value = 
                r.parameters.reflectivity
            }
            ...
            z = new THREE.ShaderMaterial({fragmentShader: o.fragmentShader,vertexShader: o.vertexShader,uniforms: a,lights: true,fog: true})
        } else
            z = new THREE[r.type](r.parameters);
        I.materials[n] = z
    }
    f(I.scene, K.objects);
    i.callbackSync(I);
    ...
    if (a !== void 0)
        for (var b in a) {
            ...
            if (c === void 0)
                ...
                var d = this[b];
                d instanceof THREE.Color && c instanceof THREE.Color ? d.copy(c) : d instanceof THREE.Color && typeof c === "number" ? d.setHex(c) : d instanceof THREE.Vector3 && c instanceof THREE.Vector3 ? d.copy(c) : this[b] = c
            }
        }
};
...
THREE.SkinnedMesh.prototype.updateMatrixWorld = function(a) {
    ...
    for (b = this.bones.length; a < b; a++) {
        ...
        THREE.SkinnedMesh.offsetMatrix.flattenToArrayOffset(this.boneMatrices, a * 16)
    }
    if (this.useVertexTexture)
...
THREE.MorphAnimMesh.prototype.parseAnimations = function() {
    ...
    if (!a.animations)
        a.animations = {};
    for (var b, c = a.animations, d = /([a-z]+)(\d+)/, f = 0, e = a.morphTargets.length; f < e; f++) {
...
THREE.CanvasRenderer = function(a) {
    ...
    var a = a || {}, e = this, g, h, i, j = new THREE.Projector, l = a.canvas !== 
    ...
    Da = new THREE.Vector3, ab, bb, gb, Pa, Qa, hb, a = 16;
    ...
    this.clear = function() {
        ...
        if (Fa.isEmpty() === false) {
            Fa.minSelf(fb);
            Fa.inflate(2);
            t < 1 && o.clearRect(Math.floor(Fa.getX()), Math.floor(Fa.getY()), Math.floor(Fa.getWidth()), Math.floor(Fa.getHeight()));
            if (t > 0) {
                c(THREE.NormalBlending);
                b(1);
                f("rgba(" + Math.floor(r.r * 255) + "," + Math.floor(r.g * 255) + "," + Math.floor(r.b * 255) + "," + t + ")");
                o.fillRect(Math.floor(Fa.getX()), Math.floor(Fa.getY()), Math.floor(Fa.getWidth()), Math.floor(Fa.getHeight()))
            }
            Fa.empty()
        }
    };
    this.render = function(a, k) {
        function l(a, b, c) {
            for (var d = 0, f = i.length; d < f; d++) {
                ...
                if (e instanceof THREE.DirectionalLight) {
                    var h = e.matrixWorld.getPosition().normalize(), k = b.dot(h);
                    if (!(k <= 0)) {
                        k = k * e.intensity;
                        c.r = c.r + g.r * k;
                        c.g = c.g + g.g * k;
                    ...
                    if (!(k <= 0)) {
                        k = k * (e.distance == 0 ? 1 : 1 - Math.min(a.distanceTo(h) / e.distance, 1));
                        if (k != 0) {
                            k = k * e.intensity;
                            c.r = c.r + g.r * k;
                            c.g = c.g + g.g * k;
        ...
        function n(a, d, f, g, h, i, j, o) {
            ...
            m(F, J, I, K, V, Y);
            if ((o instanceof THREE.MeshLambertMaterial || o instanceof THREE.MeshPhongMaterial) && o.map === null && o.map === null)
                if (qb === true) {
                    g = o.color;
                    h = o.emissive;
                    if (o.wireframe === false && o.shading == THREE.SmoothShading && j.vertexNormalsLength == 3) {
                        ga.r = N.r = U.r = Ga.r;
                        ga.g = N.g = U.g = Ga.g;
                        ga.b = N.b = U.b = Ga.b;
                        ...
                        da.g = g.g * da.g + h.g;
                        da.b = g.b * da.b + h.b;
                        o.wireframe === true ? s(da, o.wireframeLinewidth, o.wireframeLinecap, o.wireframeLinejoin) : t(da)
                    }
                } else
                    o.wireframe === true ? s(o.color, o.wireframeLinewidth, o.wireframeLinecap, o.wireframeLinejoin) : 
                    t(o.color);
                ...
                if (o.map !== null) {
                    if (o.map.mapping instanceof THREE.UVMapping) {
                        Xa = j.uvs[0];
                        u(F, J, I, K, V, Y, Xa[g].u, Xa[g].v, Xa[h].u, Xa[h].v, Xa[i].u, Xa[i].v, o.map)
                    }
                    ...
                    if (o.envMap.mapping instanceof THREE.SphericalReflectionMapping) {
                        ...
                        ja = (Da.x * a.elements[0] + Da.y * a.elements[4] + Da.z * a.elements[8]) * 0.5 + 0.5;
                        pb = (Da.x * 
                        a.elements[1] + Da.y * a.elements[5] + Da.z * a.elements[9]) * 0.5 + 0.5;
                        Da.copy(j.vertexNormalsWorld[h]);
                        Oa = (Da.x * a.elements[0] + Da.y * a.elements[4] + Da.z * a.elements[8]) * 0.5 + 0.5;
                        Ya = (Da.x * a.elements[1] + Da.y * a.elements[5] + Da.z * a.elements[9]) * 0.5 + 0.5;
                        Da.copy(j.vertexNormalsWorld[i]);
                        wb = (Da.x * a.elements[0] + Da.y * a.elements[4] + Da.z * a.elements[8]) * 0.5 + 0.5;
                        xb = (Da.x * a.elements[1] + Da.y * a.elements[5] + Da.z * a.elements[9]) * 0.5 + 0.5;
                        u(F, J, I, K, V, Y, ja, pb, Oa, Ya, wb, xb, o.envMap)
                    }
                } else
                    o.wireframe === true ? s(o.color, o.wireframeLinewidth, 
                    o.wireframeLinecap, o.wireframeLinejoin) : t(o.color);
                ...
                o.wireframe === true ? s(da, o.wireframeLinewidth, 
                o.wireframeLinecap, o.wireframeLinejoin) : t(da)
            }
        }
        ...
        function u(a, b, c, d, e, g, h, i, k, j, l, n, m) {
            ...
            m.image === void 0 || m.image.width == 0)) {
                if (m.needsUpdate === true) {
                    var va = m.wrapS == THREE.RepeatWrapping, p = m.wrapT == THREE.RepeatWrapping;
                    Ia[m.id] = o.createPattern(m.image, va === true && p === true ? "repeat" : va === true && p === false ? "repeat-x" : va === false && p === true ? "repeat-y" : "no-repeat");
                    m.needsUpdate = false
                }
                Ia[m.id] === void 0 ? f("rgba(0,0,0,1)") : f(Ia[m.id]);
                var va = m.offset.x / m.repeat.x, p = m.offset.y / m.repeat.y, q = m.image.width * m.repeat.x, sb = m.image.height * m.repeat.y, h = (h + va) * q, i = (1 - i + p) * sb, c = c - a, d = d - b, e = e - a, g = g - b, k = (k + 
                va) * q - h, j = (1 - j + p) * sb - i, l = (l + va) * q - h, n = (1 - n + p) * sb - i, va = k * n - l * j;
                if (va === 0) {
                    if (pa[m.id] === void 0) {
        ...
        if (k instanceof THREE.Camera === false)
            ...
            var Vb, Ec, B, X;
            this.autoClear === 
            true ? this.clear() : o.setTransform(1, 0, 0, -1, q, p);
            ...
            for (Ec = h.length; Vb < Ec; Vb++) {
                ...
                if (!(X === void 0 || X.visible === false)) {
                    ...
                    if (B instanceof THREE.RenderableParticle) {
                        ...
                        b(X.opacity);
                        c(X.blending);
                        var Ea = void 0, tb = void 0, jb = void 0, kb = void 0, Wb = void 0, Tc = B = void 0;
                        ...
                        xa.addPoint(z.positionScreen.x, 
                        z.positionScreen.y);
                        ...
                        xa.add3Points(z.positionScreen.x, z.positionScreen.y, M.positionScreen.x, M.positionScreen.y, D.positionScreen.x, 
                        D.positionScreen.y);
                        ...
                        if (fb.intersects(xa) === true) {
                            ...
                            ca = B;
                            B = a;
                            e.info.render.vertices = 
                            e.info.render.vertices + 4;
                            e.info.render.faces++;
                            b(X.opacity);
                            c(X.blending);
                            if (X.map !== void 0 && X.map !== null || X.envMap !== void 0 && X.envMap !== null) {
                                ...
                                if (X instanceof THREE.MeshLambertMaterial || 
                                X instanceof THREE.MeshPhongMaterial)
                                    if (qb === true) {
                                        oa = X.color;
                                        Ea = X.emissive;
                                        if (X.wireframe === false && X.shading == THREE.SmoothShading && ca.vertexNormalsLength == 4) {
                                            ...
                                            da.b = oa.b * da.b + Ea.b;
                                            r(F, J, I, K, V, Y, $, L);
                                            X.wireframe === true ? s(da, X.wireframeLinewidth, X.wireframeLinecap, X.wireframeLinejoin) : 
                                            t(da)
                                        }
                                    } else {
                                        r(F, J, I, K, V, Y, $, L);
                                        X.wireframe === true ? s(X.color, X.wireframeLinewidth, X.wireframeLinecap, X.wireframeLinejoin) : t(X.color)
                                    }
                                    ...
                                    r(F, J, I, K, V, Y, $, L);
                                    X.wireframe === true ? s(da, X.wireframeLinewidth, X.wireframeLinecap, 
                                    X.wireframeLinejoin) : t(da)
...
THREE.UniformsUtils = {merge: function(a) {
        ...
        for (b in a) {
            ...
            for (c in a[b]) {
                d = a[b][c];
                f[b][c] = d instanceof THREE.Color || d instanceof THREE.Vector2 || d instanceof THREE.Vector3 || d instanceof THREE.Vector4 || d instanceof THREE.Matrix4 || d instanceof THREE.Texture ? d.clone() : d instanceof Array ? d.slice() : d
            }
        }
        return f
    }};
...
THREE.WebGLRenderer = function(a) {
        ...
        if (d.attributes) {
            ...
            for (var f in d.attributes) {
                ...
                if (!e.__webglInitialized || e.createUniqueBuffers) {
                    ...
                    var g = 1;
                    e.type === "v2" ? g = 2 : e.type === "v3" ? g = 3 : e.type === "v4" ? g = 4 : e.type === "c" && (g = 3);
                    e.size = g;
    ...
    function f(a) {
        return a.map || a.lightMap || a.bumpMap || a.normalMap || a.specularMap || a instanceof THREE.ShaderMaterial ? true : false
    }
    function e(a) {
        var b, 
        c, d;
    ...
    function g(a, b, c) {
        ...
        g = h.length;
        var i = a.colors, j = i.length, l = a.__vertexArray, m = a.__colorArray, n = a.__sortArray, o = a.verticesNeedUpdate, p = a.colorsNeedUpdate, q = a.__webglCustomAttributesList;
        if (c.sortParticles) {
            gb.copy(bb);
        ...
        for (var m = k; m !== b; m = m + l) {
            ...
            if (i.render) {
                ...
                if (h)
                    ...
                    if (!i)
                        continue;
                    g && Q.setBlending(i.blending, i.blendEquation, i.blendSrc, i.blendDst);
                ...
                j instanceof THREE.BufferGeometry ? Q.renderBufferDirect(d, f, e, i, j, k) : Q.renderBuffer(d, f, e, i, j, k)
            }
        }
    }
    function m(a, b, c, d, f, e, g) {
        for (var h, i, k = 0, j = a.length; k < 
        j; k++) {
            h = a[k];
            i = h.object;
            if (i.visible) {
    ...
    function u(a, b, c, d, f) {
        ...
        var e = false, g = d.program, h = g.uniforms, i = d.uniforms;
        if (g !== da) {
            k.useProgram(g);
            da = g;
            e = true
        ...
        if (d.skinning)
            if (ec && f.useVertexTexture) {
                ...
                h.boneGlobalMatrices !== null && k.uniformMatrix4fv(h.boneGlobalMatrices, false, f.boneMatrices);
        if (e) {
            if (c && d.fog) {
            ...
            if (d instanceof 
            THREE.MeshBasicMaterial || d instanceof THREE.MeshLambertMaterial || d instanceof THREE.MeshPhongMaterial) {
            ...
            if (d instanceof THREE.LineBasicMaterial) {
                ...
                i.opacity.value = d.opacity;
            if (f.receiveShadow && !d._shadowPass && 
            i.shadowMatrix) {
                c = fa = 0;
                for (e = b.length; c < e; c++) {
                    j = b[c];
                    if (j.castShadow && (j instanceof THREE.SpotLight || j instanceof THREE.DirectionalLight && !j.shadowCascade)) {
                            ...
                            if (n.image instanceof Array && n.image.length === 6) {
                                ...
                                if (c.image.length === 6)
                                    if (c.needsUpdate) {
                                        ...
                                        k.bindTexture(k.TEXTURE_CUBE_MAP, 
                                        ...
                                        for (l = 0; l < 6; l++)
                                            if (Q.autoScaleCubemaps && !e) {
                                                ...
                                                if (!(s.width <= u && s.height <= u)) {
                                                    ...
                                                    z.width = t;
                                                    z.height = u;
                                                    z.getContext("2d").drawImage(s, 0, 0, s.width, s.height, 0, 0, t, u);
                                                    s = z
                                                }
                                                m[n] = s
                                            } else
                                                j[l] = c.image[l];
                                        l = j[0];
                                        m = (l.width & l.width - 1) === 0 && (l.height & l.height - 
                                        1) === 0;
                                        n = H(c.format);
                                        s = H(c.type);
                                        ...
                                        for (l = 0; l < 6; l++)
                                            if (e) {
                                                ...
                                                for (A = u.length; z < A; z++) {
                                                    t = u[z];
                                                    k.compressedTexImage2D(k.TEXTURE_CUBE_MAP_POSITIVE_X + l, z, n, t.width, t.height, 0, t.data)
                                                }
                                            } else
            ...
            if ((d instanceof THREE.ShaderMaterial || d instanceof THREE.MeshPhongMaterial || d.envMap) && h.cameraPosition !== null) {
                ...
                k.uniform3f(h.cameraPosition, 
                b.x, b.y, b.z)
            }
            (d instanceof THREE.MeshPhongMaterial || d instanceof THREE.MeshLambertMaterial || d instanceof THREE.ShaderMaterial || d.skinning) && h.viewMatrix !== null && k.uniformMatrix4fv(h.viewMatrix, false, a._viewMatrixArray)
        }
        ...
        h.modelMatrix !== null && k.uniformMatrix4fv(h.modelMatrix, false, f.matrixWorld.elements);
        return g
    }
    function w() {
        var a = pa;
        a >= Dc && console.warn("Trying to use " + 
        a + " texture units while this GPU supports only " + Dc);
        pa = pa + 1;
        return a
    }
    function s(a, b) {
    ...
    function M(a, b, c) {
        ...
        if (Pb && b.type !== THREE.FloatType && (b.anisotropy > 1 || b.__oldAnisotropy)) {
            k.texParameterf(a, Pb.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(b.anisotropy, rc));
    ...
    var a = a || {}, O = a.canvas !== void 0 ? a.canvas : document.createElement("canvas"), 
    F = a.precision !== void 0 ? a.precision : "highp", J = a.alpha !== void 0 ? a.alpha : true, I = a.premultipliedAlpha !== void 0 ? a.premultipliedAlpha : true, K = a.antialias !== void 0 ? a.antialias : false, V = a.stencil !== void 0 ? a.stencil : true, Y = a.preserveDrawingBuffer !== void 0 ? a.preserveDrawingBuffer : false, $ = a.clearColor !== void 0 ? new THREE.Color(a.clearColor) : new THREE.Color(0), L = a.clearAlpha !== void 0 ? a.clearAlpha : 0, ba = a.maxLights !== void 0 ? a.maxLights : 4;
    this.domElement = O;
    this.context = null;
    ...
    Pb = k.getExtension("EXT_texture_filter_anisotropic") || k.getExtension("MOZ_EXT_texture_filter_anisotropic") || k.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
    ...
    Pb || console.log("THREE.WebGLRenderer: Anisotropic texture filtering not supported.");
    ...
    this.context = k;
    var Dc = k.getParameter(k.MAX_TEXTURE_IMAGE_UNITS), J = k.getParameter(k.MAX_VERTEX_TEXTURE_IMAGE_UNITS);
    ...
    this.clear = function(a, b, c) {
        var d = 0;
        if (a === void 0 || a)
            d = d | k.COLOR_BUFFER_BIT;
        if (b === void 0 || b)
            d = d | k.DEPTH_BUFFER_BIT;
        if (c === void 0 || c)
            d = d | k.STENCIL_BUFFER_BIT;
        k.clear(d)
    };
    this.clearTarget = function(a, b, 
    c, d) {
    ...
    this.renderBufferImmediate = function(a, b, c) {
        ...
        if (a.hasPositions) {
            ...
            a.positionArray, k.DYNAMIC_DRAW);
        ...
        if (a.hasNormals) {
            ...
            if (c.shading === THREE.FlatShading) {
                var d, e, f, g, h, i, j, l, n, m, o, p = a.count * 3;
                for (o = 0; o < p; o = o + 9) {
                    m = a.normalArray;
                    d = m[o];
                    e = m[o + 1];
        ...
        if (d.visible !== false) {
            ...
            if (f instanceof THREE.Mesh) {
                ...
                for (c = f.length; d < c; ++d) {
                    ...
                    Q.info.render.faces = Q.info.render.faces + 
                    f[d].count / 3
                }
    ...
    this.renderBuffer = function(a, b, c, d, e, f) {
        if (d.visible !== 
        false) {
            var g, h, c = u(a, b, c, d, f), b = c.attributes, a = false, c = e.id * 16777215 + c.id * 2 + (d.wireframe ? 1 : 0);
            if (c !== U) {
                U = c;
                a = true
            }
            if (!d.morphTargets && b.position >= 0) {
                ...
                if (f.morphTargetForcedOrder.length) {
                    ...
                    for (g = f.morphTargetInfluences; i < d.numSupportedMorphTargets && i < h.length; ) {
                        ...
                        k.vertexAttribPointer(c["morphTarget" + i], 3, k.FLOAT, false, 0, 0);
                        if (d.morphNormals) {
                            k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[h[i]]);
                            k.vertexAttribPointer(c["morphNormal" + i], 3, k.FLOAT, false, 0, 0)
                        }
                        f.__webglMorphTargetInfluences[i] = 
                        g[h[i]];
                        i++
                    }
                } else {
                    ...
                    if (h.length > d.numSupportedMorphTargets) {
                        ...
                        h.length > d.numSupportedMorphNormals ? h.sort(j) : h.length === 0 && h.push([0, 0]);
                    for (i = 0; i < d.numSupportedMorphTargets; ) {
                        if (h[i]) {
                            ...
                            k.vertexAttribPointer(c["morphTarget" + i], 3, k.FLOAT, false, 0, 0);
                            d.morphNormals && k.vertexAttribPointer(c["morphNormal" + i], 3, k.FLOAT, false, 0, 0);
            ...
            if (a) {
                if (e.__webglCustomAttributesList) {
                    g = 0;
                    for (h = 
                    e.__webglCustomAttributesList.length; g < h; g++) {
            ...
            if (f instanceof THREE.Mesh) {
                if (d.wireframe) {
                    ...
                    a && k.bindBuffer(k.ELEMENT_ARRAY_BUFFER, 
                    e.__webglFaceBuffer);
    ...
    this.render = function(a, b, c, d) {
        if (b instanceof THREE.Camera === false)
            ...
            for (e = h.length; d < e; d++) {
                ...
                g = f.object;
                f.render = false;
                if (g.visible && (!(g instanceof THREE.Mesh || g instanceof THREE.ParticleSystem) || !g.frustumCulled || ab.contains(g))) {
                    s(g, b);
    ...
    this.renderImmediateObject = function(a, b, c, d, e) {
        ...
        e.immediateRenderCallback ? e.immediateRenderCallback(f, k, ab) : e.render(function(a) {
    ...
    this.initWebGLObjects = function(a) {
        ...
        for (; a.__objectsAdded.length; ) {
                ...
                if (i instanceof THREE.Mesh) {
                    ...
                    if (m instanceof THREE.Geometry) {
                        if (m.geometryGroups === void 0) {
                            var s = m, u = void 0, v = void 0, w = void 0, z = void 0, A = void 0, B = void 0, E = void 0, D = {}, G = s.morphTargets.length, H = s.morphNormals.length;
                            s.geometryGroups = {};
                            u = 0;
                            for (v = s.faces.length; u < v; u++) {
                                ...
                                (s.geometryGroups[E] = {faces3: [],faces4: [],materialIndex: z,vertices: 0,numMorphTargets: G,numMorphNormals: H});
                                A = w instanceof THREE.Face3 ? 3 : 4;
                                if (s.geometryGroups[E].vertices + A > 65535) {
                                    D[B].counter = D[B].counter + 1;
                                    E = D[B].hash + "_" + D[B].counter;
                                    s.geometryGroups[E] === void 0 && (s.geometryGroups[E] = {faces3: [],faces4: [],materialIndex: z,vertices: 0,numMorphTargets: G,numMorphNormals: H})
                                }
                                w instanceof THREE.Face3 ? s.geometryGroups[E].faces3.push(u) : s.geometryGroups[E].faces4.push(u);
                                s.geometryGroups[E].vertices = s.geometryGroups[E].vertices + 
                                A
                            }
                        ...
                        for (l in m.geometryGroups) {
                            ...
                            if (!n.__webglVertexBuffer) {
                                ...
                                Q.info.memory.geometries++;
                                var N = n, K = i, M = K.geometry, O = N.faces3, da = N.faces4, U = O.length * 3 + da.length * 4, ga = O.length * 
                                1 + da.length * 2, V = O.length * 3 + da.length * 4, $ = c(K, N), ba = f($), ia = d($), fa = $.vertexColors ? $.vertexColors : false;
                                ...
                                if ($.attributes) {
                                    ...
                                    for (ua in $.attributes) {
                                        var Ca = $.attributes[ua], ja = {}, Ja;
                                        for (Ja in Ca)
                                            ja[Ja] = Ca[Ja];
                                        if (!ja.__webglInitialized || ja.createUniqueBuffers) {
                                            ja.__webglInitialized = true;
                                            var ta = 1;
                                            ja.type === "v2" ? ta = 2 : ja.type === "v3" ? ta = 3 : ja.type === "v4" ? ta = 4 : ja.type === "c" && (ta = 3);
                                            ja.size = ta;
                        ...
                        m instanceof THREE.BufferGeometry && e(m)
                    ...
                    if (!m.__webglVertexBuffer) {
                        ...
                        Q.info.memory.geometries++;
                        var xa = m, Ga = xa.vertices.length;
                        xa.__vertexArray = new Float32Array(Ga * 3);
                        xa.__colorArray = 
                        new Float32Array(Ga * 3);
                    ...
                    if (!m.__webglVertexBuffer) {
                        ...
                        Q.info.memory.geometries++;
                        var Fa = m, Pa = i, Qa = Fa.vertices.length;
                ...
                THREE.ParticleSystem) {
                    ...
                    if (!m.__webglVertexBuffer)
                        if (m instanceof THREE.Geometry) {
                            ...
                            Q.info.memory.geometries++;
                            var Ya = m, pb = i, fb = Ya.vertices.length;
            ...
            if (!i.__webglActive) {
                ...
                } else if (i instanceof THREE.Ribbon || i instanceof THREE.Line || i instanceof THREE.ParticleSystem) {
                    m = i.geometry;
                    q(j.__webglObjects, m, i)
                } else
                    i instanceof THREE.ImmediateRenderObject || i.immediateRenderCallback ? j.__webglObjectsImmediate.push({object: i,opaque: null,transparent: null}) : i instanceof THREE.Sprite ? j.__webglSprites.push(i) : i instanceof 
                    THREE.LensFlare && j.__webglFlares.push(i);
                i.__webglActive = true
            }
            a.__objectsAdded.splice(0, 1)
        }
        for (; a.__objectsRemoved.length; ) {
            var lb = a.__objectsRemoved[0], $a = a;
        ...
        for (var hb = 0, rb = a.__webglObjects.length; hb < rb; hb++) {
            var ub = a.__webglObjects[hb].object, ea = ub.geometry, bb = void 0, ab = void 0, cb = void 0;
            if (ub instanceof THREE.Mesh)
                if (ea instanceof THREE.BufferGeometry) {
                    (ea.verticesNeedUpdate || ea.elementsNeedUpdate || ea.uvsNeedUpdate || ea.normalsNeedUpdate || ea.colorsNeedUpdate || ea.tangentsNeedUpdate) && h(ea, k.DYNAMIC_DRAW, !ea.dynamic);
                    ...
                    for (var qb = 0, wb = ea.geometryGroupsList.length; qb < wb; qb++) {
                        ...
                        if (ea.verticesNeedUpdate || ea.morphTargetsNeedUpdate || ea.elementsNeedUpdate || ea.uvsNeedUpdate || ea.normalsNeedUpdate || ea.colorsNeedUpdate || ea.tangentsNeedUpdate || ab) {
                            var la = bb, xb = ub, mb = k.DYNAMIC_DRAW, yb = !ea.dynamic, gb = cb;
                            if (la.__inittedArrays) {
                                var Pb = d(gb), ec = gb.vertexColors ? gb.vertexColors : false, 
                                ...
                                gc = db.vertices, ma = la.faces3, na = la.faces4, Wa = db.faces, Xc = db.faceVertexUvs[0], Yc = db.faceVertexUvs[1], hc = db.skinIndices, ac = db.skinWeights, bc = db.morphTargets, Hc = db.morphNormals;
                                ...
                                if (id) {
                                    ...
                                    for (rc = bc.length; Ra < rc; Ra++) {
                                        ...
                                        for (W = na.length; C < W; C++) {
                                            ...
                                            if (gb.morphNormals) {
                                                if (Fc) {
                                                    ...
                                                    tc = Eb = Db = Cb = Hc[Ra].faceNormals[$b];
                                                Na = Vc[Ra];
                                                Na[ha] = Cb.x;
                                                Na[ha + 1] = Cb.y;
                                                Na[ha + 2] = Cb.z;
                                        ...
                                        k.bindBuffer(k.ARRAY_BUFFER, la.__webglMorphTargetsBuffers[Ra]);
                ...
                if (ea.verticesNeedUpdate || ea.colorsNeedUpdate) {
                    var cc = ea, bd = k.DYNAMIC_DRAW, zc = void 0, Ac = void 0, Ic = void 0, dc = void 0, Jc = void 0, cd = cc.vertices, dd = cc.colors, 
                    jd = cd.length, kd = dd.length, Kc = cc.__vertexArray, Lc = cc.__colorArray, ld = cc.colorsNeedUpdate;
                ...
                if (ea.verticesNeedUpdate || ea.colorsNeedUpdate || ab) {
                    var Ub = ea, Zc = k.DYNAMIC_DRAW, Bc = void 0, Cc = void 0, Mc = void 0, Ba = void 0, Nc = void 0, ed = Ub.vertices, fd = Ub.colors, md = ed.length, nd = fd.length, Oc = Ub.__vertexArray, Pc = Ub.__colorArray, od = Ub.colorsNeedUpdate, $c = Ub.__webglCustomAttributesList, Qc = void 0, gd = void 0, Ua = void 0, pc = void 0, eb = void 0, wa = void 0;
                    ...
                    if ($c) {
                        ...
                        for (gd = $c.length; Qc < gd; Qc++) {
                            wa = $c[Qc];
                            if (wa.needsUpdate && (wa.boundTo === void 0 || wa.boundTo === "vertices")) {
                                Ba = 0;
                                pc = wa.value.length;
                                if (wa.size === 1)
                                    for (Ua = 0; Ua < pc; Ua++)
                ...
                if (ea instanceof THREE.BufferGeometry) {
                    (ea.verticesNeedUpdate || ea.colorsNeedUpdate) && h(ea, k.DYNAMIC_DRAW, !ea.dynamic);
                    ea.verticesNeedUpdate = false;
                    ea.colorsNeedUpdate = false
                } else {
                    cb = c(ub, bb);
                    ab = cb.attributes && p(cb);
                    (ea.verticesNeedUpdate || ea.colorsNeedUpdate || ub.sortParticles || ab) && g(ea, k.DYNAMIC_DRAW, ub);
                    ea.verticesNeedUpdate = false;
                    ea.colorsNeedUpdate = 
                    false;
                    cb.attributes && o(cb)
    ...
    this.initMaterial = function(a, b, c, d) {
        ...
        a: 
        {
            q = a.fragmentShader;
            p = a.vertexShader;
            var o = a.uniforms, b = a.attributes, c = {map: !!a.map,envMap: !!a.envMap,lightMap: !!a.lightMap,bumpMap: !!a.bumpMap,normalMap: !!a.normalMap,
                ...
                d.receiveShadow,shadowMapSoft: this.shadowMapSoft,shadowMapDebug: this.shadowMapDebug,shadowMapCascade: this.shadowMapCascade,alphaTest: a.alphaTest,metal: a.metal,perPixel: a.perPixel,wrapAround: a.wrapAround,doubleSided: a.side === THREE.DoubleSide,flipSided: a.side === THREE.BackSide
            }, s, d = [];
            if (n)
                d.push(n);
            else {
            ...
            s.uniforms = {};
            s.attributes = {};
            var t, d = ["viewMatrix", "modelViewMatrix", "projectionMatrix", "normalMatrix", "modelMatrix", "cameraPosition", "morphTargetInfluences"];
            ...
            d = ["position", "normal", "uv", "uv2", "tangent", "color", "skinIndex", "skinWeight"];
            for (t = 
            0; t < c.maxMorphTargets; t++)
                d.push("morphTarget" + t);
    ...
    this.setBlending = function(a, b, c, d) {
        if (a !== Ja) {
            ...
            } else if (a === THREE.CustomBlending)
                k.enable(k.BLEND);
            else {
                k.enable(k.BLEND);
    ...
    this.setTexture = function(a, b) {
        if (a.needsUpdate) {
            ...
            if (a instanceof THREE.CompressedTexture)
                for (var f = 
                a.mipmaps, g = 0, h = f.length; g < h; g++) {
                    c = f[g];
                    k.compressedTexImage2D(k.TEXTURE_2D, g, e, c.width, c.height, 0, c.data)
                }
            else
...
THREE.ColorUtils = {adjustHSV: function(a, b, c, d) {
        ...
        var c = a.r, d = a.g, f = a.b, e = Math.max(Math.max(c, d), f), g = Math.min(Math.min(c, d), f);
        if (g === e)
            g = c = 0;
        else {
            var h = e - g, g = h / e, c = (c === e ? (d - f) / h : d === e ? 2 + (f - c) / h : 4 + (c - d) / h) / 6;
            c < 0 && (c = c + 1);
            c > 1 && (c = c - 1)
        }
...
THREE.GeometryUtils = {merge: function(a, b) {
        for (var c, d, f = a.vertices.length, e = b instanceof THREE.Mesh ? b.geometry : b, g = a.vertices, h = e.vertices, i = a.faces, j = e.faces, l = a.faceVertexUvs[0], n = e.faceVertexUvs[0], m = {}, q = 0; q < a.materials.length; q++)
        ...
        for (p = j.length; q < p; q++) {
            var g = 
            j[q], r, t, u = g.vertexNormals, w = g.vertexColors;
            g instanceof THREE.Face3 ? r = new THREE.Face3(g.a + f, g.b + f, g.c + f) : g instanceof THREE.Face4 && (r = new THREE.Face4(g.a + f, g.b + f, g.c + f, g.d + f));
        ...
        var b = new THREE.Geometry, c, d = a.vertices, f = a.faces, e = a.faceVertexUvs[0];
        if (a.materials)
        ...
        var d, f, e, g = new THREE.Vector3, h = THREE.GeometryUtils.__v1;
        ...
        if (a instanceof THREE.Face4) {
            ...
            (c + g) < c ? THREE.GeometryUtils.randomPointInTriangle(d, f, b) : THREE.GeometryUtils.randomPointInTriangle(f, e, b)
        }
        ...
        var d, f, e = a.faces, g = a.vertices, h = e.length, i = 0, j = [], l, n, m, q;
        for (f = 0; f < h; f++) {
            d = e[f];
        ...
        for (var a = a.faceVertexUvs[0], b = 0, c = a.length; b < c; b++)
            for (var d = a[b], f = 0, e = d.length; f < e; f++) {
                if (d[f].u !== 1)
                    d[f].u = d[f].u - Math.floor(d[f].u);
                if (d[f].v !== 1)
                    d[f].v = d[f].v - Math.floor(d[f].v)
            }
        ...
        for (c = a.faces.length; b < c; b++) {
            ...
            if (d instanceof THREE.Face4) {
                ...
                d = 0;
                for (f = a.faceVertexUvs.length; d < 
                f; d++)
        ...
        for (var b = [], c = 0, d = a.faces.length; c < d; c++) {
            var f = b.length, e = a.faces[c];
            if (e instanceof THREE.Face4) {
                var g = e.a, h = e.b, i = e.c, g = a.vertices[g], h = a.vertices[h], i = a.vertices[i], j = a.vertices[e.d];
                b.push(g.clone());
                b.push(h.clone());
                b.push(i.clone());
                b.push(j.clone());
        ...
        var c, d, f, e, g, h, i, j, l, n, m, q, p, o, r, t, u, w, s, B = [], v = [];
        c = 0;
...
THREE.ImageUtils = {crossOrigin: "anonymous",loadTexture: function(a, b, c, d) {
        var f = new Image, e = new THREE.Texture(f, b), b = new THREE.ImageLoader;
        ...
        e.onload = function() {
            var a = THREE.ImageUtils.parseDDS(e.response, 
            true);
            f.format = a.format;
            f.mipmaps = a.mipmaps;
        ...
        var d = {mipmaps: [],width: 0,height: 0,format: null,mipmapCount: 1}, f = c("DXT1"), e = c("DXT3"), g = c("DXT5"), h = new Int32Array(a, 0, 31);
        if (h[0] !== 542327876) {
        ...
        switch (i) {
            ...
            case g:
                ...
                break;
            default:
                console.error("ImageUtils.parseDDS(): Unsupported FourCC code: ", String.fromCharCode(i & 255, i >> 8 & 255, i >> 16 & 255, i >> 24 & 255));
                return d
        }
        d.mipmapCount = 1;
        if (h[2] & 131072 && b !== false)
            d.mipmapCount = Math.max(1, 
            h[7]);
        d.width = h[4];
        d.height = h[3];
        h = h[1] + 4;
        ...
        for (i = 0; i < d.mipmapCount; i++) {
            var j = Math.max(4, e) / 4 * Math.max(4, g) / 4 * f, l = {data: new Uint8Array(a, h, j),width: e,height: g};
            d.mipmaps.push(l);
            h = h + j;
            e = Math.max(e * 0.5, 1);
            g = Math.max(g * 0.5, 1)
        ...
        }, b = b | 1, d = a.width, f = a.height, e = document.createElement("canvas");
        e.width = d;
        e.height = f;
        var g = e.getContext("2d");
        g.drawImage(a, 0, 0);
        for (var h = g.getImageData(0, 0, d, f).data, i = g.createImageData(d, f), j = i.data, l = 0; l < d; l++)
            for (var n = 0; n < f; n++) {
                var m = n - 1 < 0 ? 0 : n - 1, q = n + 1 > f - 1 ? f - 1 : n + 1, p = l - 1 < 0 ? 0 : l - 1, o = l + 1 > d - 1 ? d - 1 : l + 1, r = [], t = [0, 0, h[(n * d + l) * 4] / 255 * b];
                ...
                p; q++) {
                    ...
                    m.push(c([o[1] * u[2] - o[2] * u[1], o[2] * u[0] - o[0] * u[2], o[0] * u[1] - o[1] * u[0]]))
                }
                r = [0, 0, 0];
        ...
        for (var d = a * b, f = new Uint8Array(3 * 
        d), e = Math.floor(c.r * 255), g = Math.floor(c.g * 255), c = Math.floor(c.b * 255), h = 0; h < d; h++) {
            f[h * 3] = e;
            f[h * 3 + 1] = g;
            f[h * 3 + 2] = c
        }
...
THREE.FontUtils = {faces: {},face: "helvetiker",weight: "normal",style: "normal",size: 150,divisions: 10,getFace: function() {
        ...
        0, f = String(a).split(""), e = f.length, g = [], a = 0; a < e; a++) {
        ...
        var e = [], g, h, i, j, l, n, m, q, p, o, r, t = b.glyphs[a] || b.glyphs["?"];
        if (t) {
            if (t.o) {
...
THREE.FontUtils.generateShapes = function(a, b) {
    var b = b || {}, c = b.curveSegments !== void 0 ? b.curveSegments : 4, d = b.font !== void 0 ? b.font : "helvetiker", f = b.weight !== void 0 ? b.weight : "normal", e = b.style !== void 0 ? b.style : "normal";
...
(function(a) {
    ...
    a.Triangulate = function(a, d) {
        ...
        for (j = f - 1; f > 2; ) {
            ...
            {
                m = a;
                var q = i, p = j, o = l, r = f, t = g, u = void 0, w = void 0, s = void 0, B = void 0, v = void 0, 
                A = void 0, E = void 0, z = void 0, M = void 0, w = m[t[q]].x, s = m[t[q]].y, B = m[t[p]].x, v = m[t[p]].y, A = m[t[o]].x, E = m[t[o]].y;
                if (1E-10 > (B - w) * (E - s) - (v - s) * (A - w))
                    m = false;
                else {
                    for (u = 0; u < r; u++)
                        if (!(u == q || u == p || u == o)) {
                            var z = m[t[u]].x, M = m[t[u]].y, D = void 0, G = void 0, H = void 0, O = void 0, F = void 0, J = void 0, I = void 0, K = void 0, V = void 0, Y = void 0, $ = void 0, L = void 0, D = H = F = void 0, D = A - B, G = E - v, H = w - A, O = s - E, F = B - w, J = v - s, I = z - w, K = M - s, V = z - B, Y = M - v, $ = z - A, L = M - E, D = D * Y - G * V, F = F * K - J * I, H = H * L - O * $;
                            if (D >= 0 && H >= 0 && F >= 0) {
                                m = false;
                                break a
                            }
...
THREE.Curve.prototype.getLengths = function(a) {
    ...
    this.needsUpdate = false;
    var b = [], c, d = this.getPoint(0), f, e = 0;
    b.push(0);
    for (f = 1; f <= a; f++) {
        c = this.getPoint(f / a);
        e = e + c.distanceTo(d);
...
THREE.Curve.prototype.getUtoTmapping = function(a, b) {
    var c = this.getLengths(), d = 0, f = c.length, e;
    e = b ? b : a * c[f - 1];
...
THREE.SplineCurve3 = THREE.Curve.create(function(a) {
    ...
    var b = new THREE.Vector3, c = [], d = this.points, f, a = (d.length - 1) * a;
    f = Math.floor(a);
    a = a - f;
    c[0] = f == 0 ? f : f - 1;
    c[1] = f;
...
THREE.CurvePath.prototype.getBoundingBox = function() {
    var a = this.getPoints(), b, c, d, f, e, g;
...
THREE.CurvePath.prototype.getWrapPoints = function(a, b) {
    var c = this.getBoundingBox(), d, f, e, g, h, i;
    d = 0;
...
THREE.Path.prototype.bezierCurveTo = function(a, b, c, d, f, e) {
    var g = Array.prototype.slice.call(arguments), h = this.actions[this.actions.length - 1].args, h = new THREE.CubicBezierCurve(new THREE.Vector2(h[h.length - 2], h[h.length - 1]), new THREE.Vector2(a, b), new THREE.Vector2(c, d), new THREE.Vector2(f, e));
    this.curves.push(h);
...
THREE.Path.prototype.absellipse = function(a, b, c, d, f, e, g) {
    var h = Array.prototype.slice.call(arguments), i = new THREE.EllipseCurve(a, b, c, d, f, e, g);
    this.curves.push(i);
    i = i.getPoint(g ? 1 : 0);
    h.push(i.x);
    h.push(i.y);
...
THREE.Path.prototype.getPoints = function(a, b) {
    ...
    var a = a || 12, c = [], d, f, e, g, h, i, j, l, n, m, q, p, o;
    d = 0;
...
THREE.Path.prototype.toShapes = function() {
    var a, b, c, d, f = [], e = new THREE.Path;
    a = 0;
...
THREE.Shape.Utils = {removeHoles: function(a, b) {
        var c = a.concat(), d = c.concat(), f, e, g, h, i, j, l, n, m, q, p = [];
        ...
        var c = THREE.Shape.Utils.removeHoles(a, b), d = c.allpoints, f = c.isolatedPts, c = THREE.FontUtils.Triangulate(c.shape, false), e, g, h, i, j = {};
        e = 0;
...
THREE.Animation.prototype.update = function(a) {
    if (this.isPlaying !== false) {
        var b = ["pos", "rot", "scl"], c, d, f, e, g, h, i, j, l;
    ...
    for (b = this.hierarchy.length; a < b; a++) {
        ...
        if (this.data.hierarchy[a].keys.length && c) {
            for (var f = 0; f < c.length; f++) {
                var e = c[f], g = this.getNextKeyWith(e, a, 0);
                g && g.apply(e)
            }
            d.matrixAutoUpdate = 
            false;
...
THREE.KeyFrameAnimation.prototype.play = function(a, b) {
    if (!this.isPlaying) {
        ...
        var c, d = this.hierarchy.length, f, e;
        for (c = 0; c < d; c++) {
            f = this.hierarchy[c];
            ...
            if (e.animationCache === void 0) {
                ...
                e.animationCache.originalMatrix = f instanceof THREE.Bone ? 
                f.skinMatrix : f.matrix
            }
...
THREE.KeyFrameAnimation.prototype.update = function(a) {
    if (this.isPlaying) {
        var b, c, d, f, e = this.data.JIT.hierarchy, g, h, i;
        ...
        f = parseInt(Math.min(g * this.data.fps, this.data.length * this.data.fps), 10);
        if ((i = g < h) && !this.loop) {
            for (var a = 0, j = this.hierarchy.length; a < j; a++) {
                var l = this.data.hierarchy[a].keys, e = this.data.hierarchy[a].sids;
                d = l.length - 1;
                f = 
                this.hierarchy[a];
                if (l.length) {
            ...
            for (j = this.hierarchy.length; a < j; a++) {
                ...
                if (this.JITCompile && e[a][f] !== void 0)
                    ...
                    if (this.JITCompile && n)
                        d instanceof THREE.Bone ? d.skinMatrix = n.originalMatrix : d.matrix = n.originalMatrix;
                    b = n.prevKey;
                    c = n.nextKey;
                    if (b && c) {
                        if (c.time <= h) {
            ...
            if (this.JITCompile && e[0][f] === void 0) {
                ...
                for (a = 0; a < this.hierarchy.length; a++)
                    e[a][f] = this.hierarchy[a] instanceof THREE.Bone ? this.hierarchy[a].skinMatrix.clone() : this.hierarchy[a].matrix.clone()
            }
        }
    }
};
...
THREE.CombinedCamera = function(a, b, c, d, f, e, g) {
    ...
    this.top = b / 2;
    this.bottom = -b / 2;
    this.cameraO = new THREE.OrthographicCamera(a / -2, a / 2, b / 2, b / -2, e, g);
...
THREE.FirstPersonControls = function(a, b) {
    ...
    this.update = function(a) {
        ...
        if (!this.freeze) {
            ...
            var b = 
            this.target, c = this.object.position;
            ...
            if (this.constrainVertical)
                this.phi = THREE.Math.mapLinear(this.phi, 
...
THREE.PathControls = function(a, b) {
    ...
    this.init = function() {
        ...
        if (this.createDebugDummy) {
            ...
            b = new THREE.MeshLambertMaterial({color: 65280}), c = new THREE.CubeGeometry(10, 10, 20), g = new THREE.CubeGeometry(2, 2, 10);
        ...
        if (this.createDebugPath) {
            var a = 
            this.debugPath, b = this.spline, g = e(b, 10), c = e(b, 10), h = new THREE.LineBasicMaterial({color: 16711680,linewidth: 3}), g = new THREE.Line(g, h), c = new THREE.ParticleSystem(c, new THREE.ParticleBasicMaterial({color: 16755200,size: 3}));
            g.scale.set(1, 1, 1);
            a.add(g);
            c.scale.set(1, 1, 1);
            a.add(c);
...
THREE.RollControls = function(a, b) {
    ...
    this.roll = 0;
    var c = new THREE.Vector3, d = new THREE.Vector3, f = new THREE.Vector3, e = new THREE.Matrix4, g = false, h = 1, i = 0, j = 0, l = 0, n = 0, m = 0, q = 0, p = 0;
    this.handleResize = function() {
...
THREE.TrackballControls = function(a, b) {
    ...
    var f = new THREE.Vector3, e = false, g = -1, h = new THREE.Vector3, i = new THREE.Vector3, j = new THREE.Vector3, l = new THREE.Vector2, n = new THREE.Vector2, m = new THREE.Vector2, q = new THREE.Vector2, p = {type: "change"};
    this.handleResize = function() {
        ...
        this.radius = 
        (this.screen.width + this.screen.height) / 4
    };
    this.handleEvent = function(a) {
        if (typeof this[a.type] == "function")
            this[a.type](a)
    ...
    this.getMouseProjectionOnBall = function(a, b) {
        var c = new THREE.Vector3((a - d.screen.width * 0.5 - d.screen.offsetLeft) / d.radius, (d.screen.height * 0.5 + d.screen.offsetTop - b) / d.radius, 0), e = c.length();
    ...
    this.rotateCamera = function() {
        ...
        if (a) {
			...
			var b = this.center.cross(i, j).normalize(), c = new THREE.Quaternion, a = a * d.rotateSpeed;
    ...
    this.update = function() {
        ...
        if (f.distanceToSquared(d.object.position) > 
        0) {
            d.dispatchEvent(p);
    ...
    this.domElement.addEventListener("mousemove", function(a) {
        if (d.enabled) {
            ...
            g !== -1 && (g === 0 && !d.noRotate ? j = d.getMouseProjectionOnBall(a.clientX, a.clientY) : g === 1 && !d.noZoom ? n = d.getMouseOnScreen(a.clientX, a.clientY) : g === 
            2 && !d.noPan && (q = d.getMouseOnScreen(a.clientX, a.clientY)))
        }
    }, false);
    this.domElement.addEventListener("mousedown", function(a) {
        if (d.enabled) {
...
THREE.OrbitControls = function(a, b) {
    ...
    var e = this, g = 1800, h = new THREE.Vector2, i = new THREE.Vector2, j = new THREE.Vector2, l = new THREE.Vector2, n = new THREE.Vector2, m = new THREE.Vector2, q = 0, p = 0, o = 1, r = new THREE.Vector3, t = {NONE: -1,ROTATE: 0,ZOOM: 1}, u = t.NONE, w = {type: "change"};
    ...
    this.update = function() {
        ...
        this.autoRotate && 
        this.rotateLeft(c());
        var d = d + p, e = e + q, e = Math.max(1E-6, Math.min(Math.PI - 1E-6, e)), f = b.length();
    ...
    this.domElement.addEventListener("DOMMouseScroll", function (a) {
        e.userZoom && (a.detail > 0 ? e.zoomOut() : e.zoomIn())
    }, false)
...
THREE.CircleGeometry = function(a, b, c, d) {
    THREE.Geometry.call(this);
    var a = a || 50, c = c !== void 0 ? c : 0, d = d !== void 0 ? d : Math.PI * 2, b = b !== void 0 ? Math.max(3, b) : 8, f, e = [];
    f = new THREE.Vector3;
...
THREE.CubeGeometry = function(a, b, c, d, f, e, g, h) {
    function i(a, b, c, g, h, i, l, m) {
        var n, o = d || 1, p = f || 1, q = h / 2, r = i / 2, t = j.vertices.length;
        if (a === "x" && b === "y" || a === "y" && b === "x")
            n = "z";
        ...
        var u = o + 1, w = p + 1, Y = h / o, $ = i / p, L = new THREE.Vector3;
        L[n] = l > 0 ? 1 : -1;
        for (h = 0; h < w; h++)
            for (i = 0; i < u; i++) {
    ...
    if (h != void 0)
        for (var w in h)
            this.sides[w] !== void 0 && (this.sides[w] = h[w]);
...
THREE.CylinderGeometry = function(a, b, c, d, f, e) {
    THREE.Geometry.call(this);
    var a = a !== void 0 ? a : 20, b = b !== void 0 ? b : 20, c = c !== void 0 ? c : 100, g = c / 2, d = d || 8, f = f || 1, h, i, j = [], l = [];
    for (i = 0; i <= f; i++) {
        var n = [], m = [], q = i / f, p = q * (b - a) + a;
        for (h = 0; h <= d; h++) {
...
THREE.ExtrudeGeometry.prototype.addShape = function(a, b) {
    ...
    function f(c, d) {
        ...
        for (L = c.length; --L >= 0; ) {
            ...
            for (var g = 0, h = m + l * 2, g = 0; g < h; g++) {
                var i = V * g, j = V * (g + 1), n = d + e + i, i = d + f + i, o = d + f + j, j = d + e + j, p = c, q = g, r = h, s = e, v = f, n = n + D, i = i + D, o = o + D, j = j + D;
    ...
    function g(c, d, e, f) {
        ...
        c = f ? u.generateBottomUV(M, a, b, c, d, e) : u.generateTopUV(M, a, b, c, d, e);
        M.faceVertexUvs[0].push(c)
    }
    var h = b.amount !== void 0 ? b.amount : 100, i = b.bevelThickness !== void 0 ? b.bevelThickness : 6, j = b.bevelSize !== void 0 ? b.bevelSize : i - 2, l = b.bevelSegments !== void 0 ? b.bevelSegments : 3, n = b.bevelEnabled !== void 0 ? b.bevelEnabled : true, m = b.steps !== void 0 ? b.steps : 1, q = b.extrudePath, p, o = false, r = b.material, t = b.extrudeMaterial, u = b.UVGenerator !== void 0 ? b.UVGenerator : THREE.ExtrudeGeometry.WorldUVGenerator, w, s, B, v;
    if (q) {
        p = q.getSpacedPoints(m);
        o = true;
        n = false;
        w = b.frames !== void 0 ? b.frames : new THREE.TubeGeometry.FrenetFrames(q, m, 
        false);
        s = new THREE.Vector3;
        B = new THREE.Vector3;
        v = new THREE.Vector3
    ...
    if (!n)
        j = i = l = 0;
    var A, E, z, M = this, D = this.vertices.length, q = a.extractPoints(), G = q.shape, q = q.holes, H = !THREE.Shape.Utils.isClockWise(G);
    if (H) {
        G = G.reverse();
        E = 0;
    ...
    var O = THREE.Shape.Utils.triangulateShape(G, q), H = G;
    E = 0;
    for (z = q.length; E < z; E++) {
        A = q[E];
        G = G.concat(A)
    }
    var F, J, I, K, V = G.length, Y = O.length, $ = [], L = 0, ba = H.length;
    F = ba - 1;
...
THREE.ExtrudeGeometry.WorldUVGenerator = {generateTopUV: function(a, b, c, d, f, e) {
        b = a.vertices[f].x;
        f = a.vertices[f].y;
        c = a.vertices[e].x;
        e = a.vertices[e].y;
        return [new THREE.UV(a.vertices[d].x, a.vertices[d].y), new THREE.UV(b, f), new THREE.UV(c, e)]
    },generateBottomUV: function(a, b, c, d, f, e) {
        return this.generateTopUV(a, b, c, d, f, e)
    },generateSideWallUV: function(a, b, c, d, f, e, g, h) {
        var b = a.vertices[f].x, c = a.vertices[f].y, f = a.vertices[f].z, d = a.vertices[e].x, i = a.vertices[e].y, e = a.vertices[e].z, j = a.vertices[g].x, l = a.vertices[g].y, 
        g = a.vertices[g].z, n = a.vertices[h].x, m = a.vertices[h].y, a = a.vertices[h].z;
        return Math.abs(c - i) < 0.01 ? [new THREE.UV(b, 1 - f), new THREE.UV(d, 1 - e), new THREE.UV(j, 1 - g), new THREE.UV(n, 1 - a)] : [new THREE.UV(c, 1 - f), new THREE.UV(i, 1 - e), new THREE.UV(l, 1 - g), new THREE.UV(m, 1 - a)]
    }
};
...
THREE.ShapeGeometry.prototype.addShape = function(a, b) {
    b === void 0 && (b = {});
    var c = b.material, d = b.UVGenerator === void 0 ? THREE.ExtrudeGeometry.WorldUVGenerator : b.UVGenerator, f, e, g, h = this.vertices.length;
    f = a.extractPoints();
    var i = f.shape, j = f.holes;
...
THREE.LatheGeometry = function(a, b, c) {
    THREE.Geometry.call(this);
    for (var b = b || 12, c = c || 2 * Math.PI, d = [], f = (new THREE.Matrix4).makeRotationZ(c / b), e = 0; e < a.length; e++) {
        d[e] = a[e].clone();
    ...
    for (c = 0; c < b; c++) {
        ...
        for (f = a.length; d < f - 1; d++) {
            this.faces.push(new THREE.Face4(c * f + d, (c + 1) % g * f + d, (c + 1) % g * f + (d + 1) % f, c * f + (d + 1) % f));
            this.faceVertexUvs[0].push([new THREE.UV(1 - c / b, d / f), new THREE.UV(1 - 
                (c + 1) / b, d / f), new THREE.UV(1 - (c + 1) / b, (d + 1) / f), new THREE.UV(1 - c / b, (d + 1) / f)])
        }
    }
    this.computeCentroids();
    this.computeFaceNormals();
...
THREE.PlaneGeometry = function(a, b, c, d) {
    THREE.Geometry.call(this);
    for (var f = a / 2, e = b / 2, c = c || 1, d = d || 1, g = c + 1, h = d + 1, i = a / c, j = b / d, l = new THREE.Vector3(0, 0, 1), a = 0; a < h; a++)
        for (b = 0; b < g; b++)
            this.vertices.push(new THREE.Vector3(b * i - f, -(a * j - e), 0));
    for (a = 0; a < d; a++)
        for (b = 0; b < c; b++) {
            f = new THREE.Face4(b + g * a, b + g * (a + 1), b + 1 + g * (a + 1), b + 1 + g * a);
            f.normal.copy(l);
...
THREE.SphereGeometry = function(a, b, c, d, f, e, g) {
    THREE.Geometry.call(this);
    var a = a || 50, d = d !== void 0 ? d : 0, f = f !== void 0 ? f : Math.PI * 2, e = e !== void 0 ? e : 0, g = g !== void 0 ? g : Math.PI, b = Math.max(3, Math.floor(b) || 8), c = Math.max(2, Math.floor(c) || 6), h, i, j = [], l = [];
    for (i = 0; i <= c; i++) {
        var n = [], m = [];
        for (h = 0; h <= b; h++) {
    ...
    for (i = 0; i < c; i++)
        for (h = 0; h < b; h++) {
            var d = j[i][h + 1], f = j[i][h], e = j[i + 1][h], g = j[i + 1][h + 1], n = this.vertices[d].clone().normalize(), m = this.vertices[f].clone().normalize(), q = this.vertices[e].clone().normalize(), p = this.vertices[g].clone().normalize(), o = l[i][h + 1].clone(), r = l[i][h].clone(), t = l[i + 1][h].clone(), u = l[i + 1][h + 1].clone();
            if (Math.abs(this.vertices[d].y) == a) {
                this.faces.push(new THREE.Face3(d, e, g, [n, q, p]));
                this.faceVertexUvs[0].push([o, t, u])
            } else if (Math.abs(this.vertices[e].y) == 
            a) {
...
THREE.TorusGeometry = function(a, b, c, d, f) {
    ...
    for (c = 0; c <= this.segmentsR; c++)
        for (d = 0; d <= this.segmentsT; d++) {
            var e = d / this.segmentsT * this.arc, g = c / this.segmentsR * Math.PI * 2;
    ...
    for (c = 1; c <= this.segmentsR; c++)
        for (d = 1; d <= this.segmentsT; d++) {
            var f = (this.segmentsT + 1) * c + d - 1, e = (this.segmentsT + 1) * (c - 1) + d - 1, g = (this.segmentsT + 1) * (c - 1) + d, h = (this.segmentsT + 1) * c + d, i = new THREE.Face4(f, e, g, h, [b[f], b[e], b[g], b[h]]);
            ...
            i.normal.normalize();
            this.faces.push(i);
            this.faceVertexUvs[0].push([a[f].clone(), 
                a[e].clone(), a[g].clone(), a[h].clone()])
        }
    this.computeCentroids()
};
...
THREE.TorusKnotGeometry = function(a, b, c, d, f, e, g) {
    ...
    for (a = 0; a < this.segmentsR; ++a) {
        ...
        for (b = 0; b < this.segmentsT; ++b) {
            var i = a / this.segmentsR * 2 * this.p * Math.PI, g = b / this.segmentsT * 2 * Math.PI, e = h(i, g, this.q, this.p, this.radius, this.heightScale), i = h(i + 0.01, g, this.q, this.p, this.radius, this.heightScale);
            c.sub(i, e);
            d.add(i, e);
            f.cross(c, d);
            d.cross(f, c);
            ...
            e.y = e.y + (i * d.y + g * f.y);
            e.z = e.z + (i * d.z + g * f.z);
            this.grid[a][b] = this.vertices.push(new THREE.Vector3(e.x, e.y, e.z)) - 1
        }
    }
    for (a = 0; a < 
    this.segmentsR; ++a)
        for (b = 0; b < this.segmentsT; ++b) {
            var f = (a + 1) % this.segmentsR, e = (b + 1) % this.segmentsT, c = this.grid[a][b], d = this.grid[f][b], f = this.grid[f][e], e = this.grid[a][e], g = new THREE.UV(a / this.segmentsR, b / this.segmentsT), i = new THREE.UV((a + 1) / this.segmentsR, b / this.segmentsT), j = new THREE.UV((a + 1) / this.segmentsR, (b + 1) / this.segmentsT), l = new THREE.UV(a / this.segmentsR, (b + 1) / this.segmentsT);
...
THREE.TubeGeometry = function(a, b, c, d, f, e) {
    ...
    this.grid = [];
    var g, h, e = this.segments + 1, i, j, l, n = new THREE.Vector3, m, q, p, b = new THREE.TubeGeometry.FrenetFrames(a, b, f);
    m = b.tangents;
    q = b.normals;
    p = b.binormals;
    this.tangents = m;
...
THREE.TubeGeometry.FrenetFrames = function(a, b, c) {
    ...
    new THREE.Vector3;
    var f = [], e = [], g = [], h = new THREE.Vector3, i = new THREE.Matrix4, b = b + 1, j, l, n;
    this.tangents = f;
    this.normals = e;
    this.binormals = g;
    for (j = 0; j < b; j++) {
...
THREE.PolyhedronGeometry = function(a, b, c, d) {
    ...
    function g(a, b) {
        ...
        c === void 0 && (n[a.index][b.index] = n[b.index][a.index] = c = f((new THREE.Vector3).add(a, b).divideScalar(2)));
        return c
    }
    function h(a, b, c) {
...
THREE.ParametricGeometry = function(a, b, c, d) {
    THREE.Geometry.call(this);
    var f = this.vertices, e = this.faces, g = this.faceVertexUvs[0], d = d === void 0 ? false : d, h, i, j, l, n = b + 1;
    for (h = 0; h <= c; h++) {
        l = h / c;
        for (i = 0; i <= b; i++) {
            j = i / b;
...
THREE.SubdivisionModifier.prototype.smooth = function(a) {
    ...
    function d(a, c, d, f, g, h, m) {
        ...
        if (l.supportUVs) {
            ...
            g[0] ? g[1] ? g[2] ? g[3] ? j.push(g) : b("d :( ", f + ":" + m) : b("c :( ", d + ":" + m) : b("b :( ", c + ":" + m) : b("a :( ", a + ":" + m)
        }
    }
    function f(a, b) {
    ...
    var h = 
    [], i = [], j = [], l = this, n = a.vertices, m = a.faces, h = n.concat(), q = [], p = {}, o = {}, r = {}, t = n.length, u, w, s, B, v, A = a.faceVertexUvs[0];
    ...
    G = ["123", "12", "2", "23"];
    B = ["123", "23", "3", "31"];
    var O = ["123", "31", "1", "12"], F = ["1234", "12", "2", "23"], J = ["1234", "23", "3", "34"], V = ["1234", "34", "4", "41"], Y = ["1234", "41", "1", "12"];
    u = 0;
...
THREE.LensFlare.prototype.add = function(a, b, c, d, f, e) {
    ...
    this.lensFlares.push({texture: a,size: b,distance: c,x: 0,y: 0,z: 0,scale: 1,rotation: 1,opacity: e,color: f,blending: d})
};
THREE.LensFlare.prototype.updateLensFlares = function() {
    var a, b = this.lensFlares.length, c, d = -this.positionScreen.x * 2, f = -this.positionScreen.y * 2;
    for (a = 0; a < b; a++) {
        c = this.lensFlares[a];
...
THREE.MorphBlendMesh.prototype.autoCreateAnimations = function(a) {
    for (var b = /([a-z]+)(\d+)/, c, d = {}, f = this.geometry, e = 0, g = f.morphTargets.length; e < g; e++) {
...
THREE.MorphBlendMesh.prototype.update = function(a) {
    for (var b = 0, c = this.animationsList.length; b < c; b++) {
        ...
        if (d.active) {
            ...
            var e = d.startFrame + THREE.Math.clamp(Math.floor(d.time / 
            f), 0, d.length - 1), g = d.weight;
            if (e !== d.currentFrame) {
...
THREE.LensFlarePlugin = function() {
    ...
    this.render = function(a, d, f, t) {
        ...
        if (u) {
            var w = new THREE.Vector3, s = t / f, B = f * 0.5, v = t * 0.5, A = 16 / t, E = new THREE.Vector2(A * s, A), z = new THREE.Vector3(1, 1, 0), M = new THREE.Vector2(1, 1), D = m, A = n;
            b.useProgram(l);
            if (!q) {
            ...
            for (G = 0; G < u; G++) {
                ...
                E.set(A * s, A);
                F = a[G];
                w.set(F.matrixWorld.elements[12], F.matrixWorld.elements[13], F.matrixWorld.elements[14]);
                d.matrixWorldInverse.multiplyVector3(w);
                d.projectionMatrix.multiplyVector3(w);
                z.copy(w);
                M.x = z.x * B + B;
                M.y = z.y * v + v;
                if (j || M.x > 0 && M.x < f && M.y > 0 && 
                M.y < t) {
                    ...
                    b.bindTexture(b.TEXTURE_2D, i);
                    b.copyTexImage2D(b.TEXTURE_2D, 0, b.RGBA, M.x - 8, M.y - 8, 16, 16, 0);
...
THREE.ShadowMapPlugin = function() {
    var a, b, c, d, f, e, g = new THREE.Frustum, h = new THREE.Matrix4, i = new THREE.Vector3, j = new THREE.Vector3;
    this.init = function(g) {
        ...
        f = new THREE.ShaderMaterial({fragmentShader: g.fragmentShader,
            vertexShader: g.vertexShader,uniforms: h,skinning: true
        });
        e = new THREE.ShaderMaterial({fragmentShader: g.fragmentShader,vertexShader: g.vertexShader,uniforms: h,morphTargets: true,skinning: true});
        c._shadowPass = true;
        d._shadowPass = true;
        f._shadowPass = true;
        e._shadowPass = true
    ...
    this.update = function(l, n) {
        ...
        for (q = B.length; m < q; m++) {
            p = B[m];
            if (!p.shadowMap) {
                p.shadowMap = new THREE.WebGLRenderTarget(p.shadowMapWidth, p.shadowMapHeight, {minFilter: THREE.LinearFilter,magFilter: THREE.LinearFilter,format: THREE.RGBAFormat});
            ...
            if (p.cameraHelper)
                p.cameraHelper.visible = p.shadowCameraVisible;
            ...
            for (o = s.length; p < o; p++) {
                ...
                if (u.render) {
                    t = u.object;
                    u = u.buffer;
                    w = t.customDepthMaterial ? t.customDepthMaterial : t instanceof THREE.SkinnedMesh ? t.geometry.morphTargets.length ? e : f : t.geometry.morphTargets.length ? d : c;
                    u instanceof THREE.BufferGeometry ? b.renderBufferDirect(r, l.__lights, null, w, u, t) : b.renderBuffer(r, l.__lights, null, w, u, t)
                }
            }
...
THREE.SpritePlugin = function() {
    ...
    this.render = function(d, f, q, p) {
        ...
        if (o) {
            var r = i, t = j, u = p / q, q = q * 0.5, w = p * 0.5, s = true;
            b.useProgram(h);
            if (!l) {
            ...
            for (r = 0; r < o; r++) {
                B = d[r];
                if (B.visible && B.opacity !== 0 && B.map && B.map.image && B.map.image.width) {
                    if (B.useScreenCoordinates) {
                        b.uniform1i(t.useScreenCoordinates, 1);
                        b.uniform3f(t.screenPosition, (B.position.x - q) / q, (w - B.position.y) / w, Math.max(0, Math.min(1, B.position.z)))
                    } else {
                        b.uniform1i(t.useScreenCoordinates, 0);
                        b.uniform1i(t.affectedByDistance, B.affectedByDistance ? 1 : 0);
                        b.uniformMatrix4fv(t.modelViewMatrix, false, B._modelViewMatrix.elements)
                    }
...
THREE.DepthPassPlugin = function() {
    ...
    var a, b, c, d, f = new THREE.Frustum, e = new THREE.Matrix4;
    ...
    this.update = function(g, h) {
        ...
        for (j = q.length; i < j; i++) {
            ...
            m = l.object;
            l.render = false;
            if (m.visible && (!(m instanceof THREE.Mesh) || !m.frustumCulled || f.contains(m))) {
        ...
        for (j = q.length; i < j; i++) {
            ...
            if (l.render) {
                ...
                n = m.customDepthMaterial ? m.customDepthMaterial : m.geometry.morphTargets.length ? 
                d : c;
                l instanceof THREE.BufferGeometry ? b.renderBufferDirect(h, g.__lights, null, n, l, m) : b.renderBuffer(h, g.__lights, null, n, l, m)
            }
        }
