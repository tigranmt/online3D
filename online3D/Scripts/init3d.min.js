...
break;}
var modelInfo={ModelName:mesh.name,Size:mesh.filesize,Format:"Stl",ID:unique,Vertices:verticesSplit,VertexCount:verticesCount,Color:mesh.color,FaceColors:colorsSplit,SessionName:sessionInfo.sessionName,};if(index===1&&!firstLoad){modelInfo.ModelImage=_this.takeScreenshot();firstLoad=true;}
...
tempModel.SavedOn=data.SavedOn;if(data==="modeldone"){models.push(tempModel);mindex++;packet=0;tempModel={};_this.showDownloadProgress(tempModel.ModelName,100);load();}
