...
init.prototype.finalizeLoading=function(meshes){this.loadMeshesInformation.apply(this);if(meshes&&meshe.length>0){var first=meshe[0];var si=viewmodels.sessioninfo;si.sessionName=first.SessionName;si.userName=first.User;si.uploadDate=firs.SavedOn;}}
