...
{var pointClicked=TOOLS.getVertexFromMouseCoord(e);if(pointClicked!==undefined){_this.sceneTracker.center=pointClicked;_this.sceneTracker.update();_this.spotlight.position=_this.glCamera.position;}}});}};init.prototype.extensionIsOk=function(file){return true;}
