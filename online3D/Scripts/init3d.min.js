...
return;var _this=this;_this.initScene(_this);var index=meshes.length-1;var notes=new Array();var loadAsync=function(){if(index<0){_this.fitCamera.apply(_this,[_this.glScene,_this.glCamera,_this.sceneTracker]);_this.renderOnScreen();_this.finalizeLoading.apply(_this);_this.showPanels();for(var i=0;i<notes.length;i++){var note=notes[i];notesmodel.addNoteToList(note.NoteText,i+1,note.NoteVertex);}
if(notes.length>0)
