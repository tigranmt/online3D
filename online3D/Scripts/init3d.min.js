...
var screenShotTaken=false;function currentModelSequence(){var verticesSplit=new Array();while(index<verticesCount){var gv=geometryMesh.geometry.vertices[index];verticesSplit.push(gv);index++;if(index==1)
