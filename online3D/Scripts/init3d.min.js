...
init.prototype.setupSceneTracking=function(){this.sceneTracker=new THREE.TrackballControls(this.glCamera,$("#3DArea")[0]);this.sceneTracker.addEventListener('change',this.render);}
