...
break;}
var modelInfo={ModelName:mesh.name,Size:mesh.filesize,Format:"Stl",ID:unique,Vertices:verticesSplit,VertexCount:verticesCount,Color:mesh.color,};if(index===1&&!firstLoad){modelInfo.ModelImage=_this.takeScreenshot();firstLoad=true;}
