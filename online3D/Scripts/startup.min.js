...
this.openDropboxDrive=function(){var options={linkType:"direct",success:function(files){console.log(files);var appKey={key:'254hrzt7wfhcmxv',secret:'i9f2dtdx5y67wui',sandbox:true};var client=new Dropbox.Client(appKey);client.authenticate(function(error,client){if(error){console.log(error);}
