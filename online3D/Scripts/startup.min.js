...
this.openDropboxDrive=function(){var options={linkType:"direct",success:function(files){var client=new Dropbox.Client({key:"li6cyy4xgngfash",sandbox:true});client.readFile("hello_world.txt",function(error,data){if(error){return console.log(error);}
