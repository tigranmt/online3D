...
this.openDropboxDrive=function(){var options={linkType:"direct",success:function(files){var appKey={key:'254hrzt7wfhcmxv',secret:'i9f2dtdx5y67wui',sandbox:true};var client=new Dropbox.Client({key:appKey,sandbox:true});client.readFile("hello_world.txt",function(error,data){if(error){return console.log(error);}
