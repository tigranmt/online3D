...
complete(false);}});}
$(document).ready(function(){if(compatibilityChecks()){setupDragDropEvents();setupFileLoadEvents();_this.loadSampleModelPreview();userAccess.UpdateUI();$('#access').on('click',function(){userAccess.requestUserAuth();});$("#introImageSrc").lazyload();}});})