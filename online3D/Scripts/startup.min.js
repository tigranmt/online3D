...
﻿var startup=new(function(){window.indexedFiles.openbase();var _this=this;var rootMap={"STL":"/Stl/StlView"}
...
complete(true);$("#sample_preview").css('visibility','visible');data.ModelName="View sample ( "+data.ModelName+" )";ko.applyBindings(data,$("#sample_preview")[0]);},error:function(data){if(complete!==undefined)
complete(false);}});}
