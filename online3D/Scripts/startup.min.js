...
complete(false);}});}
this.init=function(){if(compatibilityChecks()){setupDragDropEvents();setupFileLoadEvents();_this.loadSampleModelPreview();userAccess.UpdateUI();$('#access').on('click',function(){userAccess.requestUserAuth();});$("#introImageSrc").lazyload();$("#iconImageSrc").lazyload();}}})