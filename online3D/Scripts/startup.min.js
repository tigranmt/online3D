...
var fileLoadingFinished=function(files){showProgress(false);loadFilesFromRemoteDriveAsync(files);}
...
return;var index=files.length;var error=false;(function loadSingleFile(){index--;if(index<0&&!error){var f0=files[0];var extension=f0.name.split('.').pop();var path=rootMap[extension.toUpperCase()];if(path){window.location.replace(path);}
return;}
