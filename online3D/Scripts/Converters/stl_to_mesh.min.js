...
else{while(readSizeTotal>0&&index>=0){bReader.readFloat();bReader.readFloat();bReader.readFloat();var vertex0={x:0,y:0,z:0},vertex1={x:0,y:0,z:0},vertex2={x:0,y:0,z:0};vertex0.x=bReader.readFloat();vertex0.y=bReader.readFloat();vertex0.z=bReader.readFloat();vertex1.x=bReader.readFloat();vertex1.y=bReader.readFloat();vertex1.z=bReader.readFloat();vertex2.x=bReader.readFloat();vertex2.y=bReader.readFloat();vertex2.z=bReader.readFloat();geometry.vertices.push(new THREE.Vector3(vertex0.x,vertex0.y,vertex0.z));geometry.vertices.push(new THREE.Vector3(vertex1.x,vertex1.y,vertex1.z));geometry.vertices.push(new THREE.Vector3(vertex2.x,vertex2.y,vertex2.z));var faceColor=bReader.readUInt16();var length=geometry.vertices.length;var face=new THREE.Face3(length-3,length-2,length-1,1);face.color.setHex(faceColor);geometry.faces.push(face);index--;i++;readSizeTotal--;}}
iterator();}
