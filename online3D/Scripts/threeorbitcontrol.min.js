...
scale*=zoomScale;};this.update=function(){var position=this.object.position;var clone=position.clone();var offset=clone.subVectors(clone,this.center);var theta=Math.atan2(offset.x,offset.z);var phi=Math.atan2(Math.sqrt(offset.x*offset.x+offset.z*offset.z),offset.y);if(this.autoRotate){this.rotateLeft(getAutoRotationAngle());}
